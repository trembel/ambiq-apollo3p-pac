...
pub struct RegisterBlock {
    ...
    pub almup: ALMUP,
    #[doc = "0x50 - RTC Control"]
    pub rtcctl: RTCCTL,
    _reserved5: [u8; 172usize],
    #[doc = "0x100 - RTC Interrupt: Enable"]
    pub inten: INTEN,
    #[doc = "0x104 - RTC Interrupt: Status"]
    pub intstat: INTSTAT,
    #[doc = "0x108 - RTC Interrupt: Clear"]
    pub intclr: INTCLR,
    #[doc = "0x10c - RTC Interrupt: Set"]
    pub intset: INTSET,
}
