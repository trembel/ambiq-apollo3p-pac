...
pub enum PAD35FNCSEL_A {
    ...
    ADCSE7 = 0,
    #[doc = "1: IOM/MSPI nCE group 35"]
    NCE35 = 1,
    #[doc = "2: Configure as the UART1 TX signal"]
    UART1TX = 2,
    #[doc = "3: Configure as GPIO35"]
    GPIO35 = 3,
    #[doc = "4: I2S serial data output"]
    I2SDAT = 4,
    #[doc = "5: CTIMER connection 27"]
    CT27 = 5,
...
pub enum PAD34FNCSEL_A {
    ...
    ADCSE6 = 0,
    #[doc = "1: IOM/MSPI nCE group 34"]
    NCE34 = 1,
    #[doc = "2: Configure as the UART1 RTS output"]
    UA1RTS = 2,
    ...
    UA0RTS = 5,
    #[doc = "6: Configure as the UART0 RX input"]
    UART0RX = 6,
...
pub enum PAD33FNCSEL_A {
    ...
    ADCSE5 = 0,
    #[doc = "1: IOM/MSPI nCE group 33"]
    NCE33 = 1,
    #[doc = "2: Configure as the 32kHz crystal output signal"]
    _32KHZXT = 2,
    #[doc = "3: Configure as GPIO33"]
    GPIO33 = 3,
    #[doc = "5: Configure as the UART0 CTS input"]
    UA0CTS = 5,
    #[doc = "6: CTIMER connection 23"]
    CT23 = 6,
...
pub enum PAD32FNCSEL_A {
    ...
    SCCIO = 4,
    #[doc = "5: External input to the LFRC oscillator"]
    EXTLF = 5,
    #[doc = "7: Configure as the UART1 CTS input"]
    UA1CTS = 7,
}
...
impl<'a> PAD32FNCSEL_W<'a> {
    ...
    #[doc = "External input to the LFRC oscillator"]
    #[inline(always)]
