...
pub enum PAD31FNCSEL_A {
    ...
    UART0RX = 4,
    #[doc = "5: SCARD serial clock output"]
    SCCCLK = 5,
...
pub enum PAD30FNCSEL_A {
    #[doc = "0: Configure as the ANATEST1 I/O signal"]
    ANATEST1 = 0,
    #[doc = "1: IOM/MSPI nCE group 30"]
    NCE30 = 1,
    ...
    UA1RTS = 5,
    #[doc = "7: Configure as the PDM I2S Data output signal"]
    I2S_DAT = 7,
}
...
impl<'a> PAD30FNCSEL_W<'a> {
    ...
    #[doc = "Configure as the PDM I2S Data output signal"]
    #[inline(always)]
...
pub enum PAD29FNCSEL_A {
    ...
    ADCSE1 = 0,
    #[doc = "1: IOM/MSPI nCE group 29"]
    NCE29 = 1,
    #[doc = "2: CTIMER connection 9"]
    CT9 = 2,
    #[doc = "3: Configure as GPIO29"]
    GPIO29 = 3,
    #[doc = "4: Configure as the UART0 CTS input signal"]
    UA0CTS = 4,
...
pub enum PAD28FNCSEL_A {
    #[doc = "0: Configure as the PDM I2S Word Clock input"]
    I2S_WCLK = 0,
    #[doc = "1: IOM/MSPI nCE group 28"]
    NCE28 = 1,
