...
pub enum PAD3FNCSEL_A {
    ...
    SLNCE = 1,
    #[doc = "2: IOM/MSPI nCE group 3"]
    NCE3 = 2,
    #[doc = "3: Configure as GPIO3"]
    GPIO3 = 3,
    #[doc = "5: MSPI data connection 7"]
    MSPI7 = 5,
    #[doc = "6: Configure as the ADC Trigger 1 signal"]
    TRIG1 = 6,
    #[doc = "7: Configure as the PDM I2S Word Clock input"]
    I2S_WCLK = 7,
}
...
impl PAD3FNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, PAD3FNCSEL_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(PAD3FNCSEL_A::UA0RTS),
            1 => Val(PAD3FNCSEL_A::SLNCE),
            2 => Val(PAD3FNCSEL_A::NCE3),
            3 => Val(PAD3FNCSEL_A::GPIO3),
            5 => Val(PAD3FNCSEL_A::MSPI7),
            6 => Val(PAD3FNCSEL_A::TRIG1),
            7 => Val(PAD3FNCSEL_A::I2S_WCLK),
            i => Res(i),
        }
    }
...
impl<'a> PAD3FNCSEL_W<'a> {
    ...
    #[doc = "Configure as the PDM I2S Word Clock input"]
    #[inline(always)]
...
pub enum PAD2FNCSEL_A {
    #[doc = "0: Configure as the UART1 RX input."]
    UART1RX = 0,
    ...
    GPIO2 = 3,
    #[doc = "5: MSPI data connection 6."]
    MSPI6 = 5,
    #[doc = "7: IOM/MSPI nCE group 2"]
    NCE2 = 7,
}
...
impl PAD2FNCSEL_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, PAD2FNCSEL_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(PAD2FNCSEL_A::UART1RX),
            1 => Val(PAD2FNCSEL_A::SLMISO),
            2 => Val(PAD2FNCSEL_A::UART0RX),
            3 => Val(PAD2FNCSEL_A::GPIO2),
            5 => Val(PAD2FNCSEL_A::MSPI6),
            7 => Val(PAD2FNCSEL_A::NCE2),
            i => Res(i),
        }
    }
...
impl<'a> PAD2FNCSEL_W<'a> {
    ...
    pub fn uart1rx(self) -> &'a mut W {
        self.variant(PAD2FNCSEL_A::UART1RX)
    }
...
pub enum PAD1FNCSEL_A {
    #[doc = "0: Configure as the IOSLAVE I2C SDA or SPI WIR3 signal"]
    SLSDAWIR3 = 0,
    ...
    GPIO1 = 3,
    #[doc = "5: MSPI data connection 5"]
    MSPI5 = 5,
    #[doc = "7: IOM/MSPI nCE group 1"]
    NCE1 = 7,
}
...
impl PAD1FNCSEL_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, PAD1FNCSEL_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(PAD1FNCSEL_A::SLSDAWIR3),
            1 => Val(PAD1FNCSEL_A::SLMOSI),
            2 => Val(PAD1FNCSEL_A::UART0TX),
            3 => Val(PAD1FNCSEL_A::GPIO1),
            5 => Val(PAD1FNCSEL_A::MSPI5),
            7 => Val(PAD1FNCSEL_A::NCE1),
            i => Res(i),
        }
    }
...
impl<'a> PAD1FNCSEL_W<'a> {
    ...
    #[doc = "Configure as the IOSLAVE I2C SDA or SPI WIR3 signal"]
    #[inline(always)]
...
pub enum PAD0FNCSEL_A {
    ...
    GPIO0 = 3,
    #[doc = "5: MSPI data connection 4"]
    MSPI4 = 5,
    #[doc = "7: IOM/MSPI nCE group 0"]
    NCE0 = 7,
}
...
impl PAD0FNCSEL_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, PAD0FNCSEL_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(PAD0FNCSEL_A::SLSCL),
            1 => Val(PAD0FNCSEL_A::SLSCK),
            2 => Val(PAD0FNCSEL_A::CLKOUT),
            3 => Val(PAD0FNCSEL_A::GPIO0),
            5 => Val(PAD0FNCSEL_A::MSPI4),
            7 => Val(PAD0FNCSEL_A::NCE0),
            i => Res(i),
        }
    }
