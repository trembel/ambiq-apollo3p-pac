...
pub enum PAD11FNCSEL_A {
    ...
    ADCSE2 = 0,
    #[doc = "1: IOM/MSPI nCE group 11"]
    NCE11 = 1,
    #[doc = "2: CTIMER connection 31"]
    CT31 = 2,
    #[doc = "3: Configure as GPIO11"]
    GPIO11 = 3,
    #[doc = "4: Configure as the IOSLAVE interrupt out signal"]
    SLINT = 4,
...
pub enum PAD10FNCSEL_A {
    ...
    M1MOSI = 1,
    #[doc = "2: IOM/MSPI nCE group 10"]
    NCE10 = 2,
    #[doc = "3: Configure as GPIO10"]
    GPIO10 = 3,
    #[doc = "4: PDM serial clock out"]
    PDMCLK = 4,
...
impl PAD10FNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, PAD10FNCSEL_A> {
        ...
        match self.bits {
            ...
            2 => Val(PAD10FNCSEL_A::NCE10),
            3 => Val(PAD10FNCSEL_A::GPIO10),
            4 => Val(PAD10FNCSEL_A::PDMCLK),
            5 => Val(PAD10FNCSEL_A::UA1RTS),
            i => Res(i),
        }
    }
...
pub enum PAD9FNCSEL_A {
    #[doc = "0: Configure as the IOMSTR1 I2C SDA or SPI WIR3 signal"]
    M1SDAWIR3 = 0,
    #[doc = "1: Configure as the IOMSTR1 SPI MISO signal"]
    M1MISO = 1,
    #[doc = "2: IOM/MSPI nCE group 9"]
    NCE9 = 2,
    #[doc = "3: Configure as GPIO9"]
    GPIO9 = 3,
    #[doc = "4: SCARD data I/O connection"]
    SCCIO = 4,
...
impl PAD9FNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, PAD9FNCSEL_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(PAD9FNCSEL_A::M1SDAWIR3),
            1 => Val(PAD9FNCSEL_A::M1MISO),
            2 => Val(PAD9FNCSEL_A::NCE9),
            3 => Val(PAD9FNCSEL_A::GPIO9),
            4 => Val(PAD9FNCSEL_A::SCCIO),
            6 => Val(PAD9FNCSEL_A::UART1RX),
            i => Res(i),
        }
    }
...
impl<'a> PAD9FNCSEL_W<'a> {
    ...
    #[doc = "Configure as the IOMSTR1 I2C SDA or SPI WIR3 signal"]
    #[inline(always)]
...
impl PAD8FNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, PAD8FNCSEL_A> {
        ...
        match self.bits {
            ...
            2 => Val(PAD8FNCSEL_A::NCE8),
            3 => Val(PAD8FNCSEL_A::GPIO8),
            4 => Val(PAD8FNCSEL_A::SCCLK),
            6 => Val(PAD8FNCSEL_A::UART1TX),
            i => Res(i),
        }
    }
