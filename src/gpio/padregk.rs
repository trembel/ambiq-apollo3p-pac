...
pub enum PAD43FNCSEL_A {
    #[doc = "0: Configure as the UART1 RX input signal"]
    UART1RX = 0,
    #[doc = "1: IOM/MSPI nCE group 43"]
    NCE43 = 1,
    #[doc = "2: CTIMER connection 18"]
    CT18 = 2,
    #[doc = "3: Configure as GPIO43"]
    GPIO43 = 3,
    #[doc = "4: Configure as the IOMSTR3 I2C SDA or SPI WIR3 signal"]
    M3SDAWIR3 = 4,
...
impl<'a> PAD43FNCSEL_W<'a> {
    ...
    #[doc = "Configure as the IOMSTR3 I2C SDA or SPI WIR3 signal"]
    #[inline(always)]
...
pub enum PAD42FNCSEL_A {
    #[doc = "0: Configure as the UART1 TX output signal"]
    UART1TX = 0,
    #[doc = "1: IOM/MSPI nCE group 42"]
    NCE42 = 1,
...
pub enum PAD41PWRDN_A {
    ...
    DIS = 0,
    #[doc = "1: Power switch enabled (Switch pad to VSS)"]
    EN = 1,
}
...
impl<'a> PAD41PWRDN_W<'a> {
    ...
    #[doc = "Power switch enabled (Switch pad to VSS)"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
pub enum PAD41FNCSEL_A {
    ...
    UA1RTS = 5,
    #[doc = "6: Configure as the UART0 TX output signal"]
    UART0TX = 6,
    #[doc = "7: Configure as the UART0 RTS output signal"]
    UA0RTS = 7,
}
...
pub enum PAD40FNCSEL_A {
    ...
    GPIO40 = 3,
    #[doc = "4: Configure as the IOMSTR4 I2C SDA or SPI WIR3 signal"]
    M4SDAWIR3 = 4,
...
impl<'a> PAD40FNCSEL_W<'a> {
    ...
    #[doc = "Configure as the IOMSTR4 I2C SDA or SPI WIR3 signal"]
    #[inline(always)]
