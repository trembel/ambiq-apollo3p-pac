...
pub enum GPIO7INTD_A {
    #[doc = "0: Applies when PAD7FNCSEL = NCE7 - nCE polarity active low"]
    NCELOW = 0,
    #[doc = "1: Applies when PAD7FNCSEL = NCE7 - nCE polarity active high"]
    NCEHIGH = 1,
}
...
impl<'a> GPIO7INTD_W<'a> {
    ...
    #[doc = "Applies when PAD7FNCSEL = NCE7 - nCE polarity active low"]
    #[inline(always)]
    pub fn n_celow(self) -> &'a mut W {
        self.variant(GPIO7INTD_A::NCELOW)
    }
    #[doc = "Applies when PAD7FNCSEL = NCE7 - nCE polarity active high"]
    #[inline(always)]
...
pub enum GPIO7OUTCFG_A {
    #[doc = "0: Applies when PAD7FNCSEL = GPIO - Output disabled"]
    DIS = 0,
    #[doc = "1: Applies when PAD7FNCSEL = GPIO - Output is push-pull"]
    PUSHPULL = 1,
    #[doc = "2: Applies when PAD7FNCSEL = GPIO - Output is open drain"]
    OD = 2,
    #[doc = "3: Applies when PAD7FNCSEL = GPIO - Output is tri-state"]
    TS = 3,
}
...
impl<'a> GPIO7OUTCFG_W<'a> {
    ...
    #[doc = "Applies when PAD7FNCSEL = GPIO - Output disabled"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(GPIO7OUTCFG_A::DIS)
    }
    #[doc = "Applies when PAD7FNCSEL = GPIO - Output is push-pull"]
    #[inline(always)]
    pub fn pushpull(self) -> &'a mut W {
        self.variant(GPIO7OUTCFG_A::PUSHPULL)
    }
    #[doc = "Applies when PAD7FNCSEL = GPIO - Output is open drain"]
    #[inline(always)]
    pub fn od(self) -> &'a mut W {
        self.variant(GPIO7OUTCFG_A::OD)
    }
    #[doc = "Applies when PAD7FNCSEL = GPIO - Output is tri-state"]
    #[inline(always)]
...
#[doc = "GPIO6 interrupt direction, nCE polarity.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum GPIO6INTD_A {
    #[doc = "0: Applies when GPIO6INCFG = 1 - No interrupt on GPIO transition"]
    INTDIS = 0,
    #[doc = "1: Applies when GPIO6INCFG = 1 - Interrupt on either low to high or high to low GPIO transition"]
    INTBOTH = 1,
}
...
impl<'a> GPIO6INTD_W<'a> {
    ...
    #[doc = "Applies when GPIO6INCFG = 1 - No interrupt on GPIO transition"]
    #[inline(always)]
    pub fn intdis(self) -> &'a mut W {
        self.variant(GPIO6INTD_A::INTDIS)
    }
    #[doc = "Applies when GPIO6INCFG = 1 - Interrupt on either low to high or high to low GPIO transition"]
    #[inline(always)]
...
pub enum GPIO6OUTCFG_A {
    #[doc = "0: Applies when PAD6FNCSEL = GPIO - Output disabled"]
    DIS = 0,
    #[doc = "1: Applies when PAD6FNCSEL = GPIO - Output is push-pull"]
    PUSHPULL = 1,
    #[doc = "2: Applies when PAD6FNCSEL = GPIO - Output is open drain"]
    OD = 2,
    #[doc = "3: Applies when PAD6FNCSEL = GPIO - Output is tri-state"]
    TS = 3,
}
...
impl<'a> GPIO6OUTCFG_W<'a> {
    ...
    #[doc = "Applies when PAD6FNCSEL = GPIO - Output disabled"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(GPIO6OUTCFG_A::DIS)
    }
    #[doc = "Applies when PAD6FNCSEL = GPIO - Output is push-pull"]
    #[inline(always)]
    pub fn pushpull(self) -> &'a mut W {
        self.variant(GPIO6OUTCFG_A::PUSHPULL)
    }
    #[doc = "Applies when PAD6FNCSEL = GPIO - Output is open drain"]
    #[inline(always)]
    pub fn od(self) -> &'a mut W {
        self.variant(GPIO6OUTCFG_A::OD)
    }
    #[doc = "Applies when PAD6FNCSEL = GPIO - Output is tri-state"]
    #[inline(always)]
    pub fn ts(self) -> &'a mut W {
...
#[doc = "GPIO5 interrupt direction, nCE polarity.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum GPIO5INTD_A {
    #[doc = "0: Applies when GPIO5INCFG = 1 - No interrupt on GPIO transition"]
    INTDIS = 0,
    #[doc = "1: Applies when GPIO5INCFG = 1 - Interrupt on either low to high or high to low GPIO transition"]
    INTBOTH = 1,
}
...
impl<'a> GPIO5INTD_W<'a> {
    ...
    #[doc = "Applies when GPIO5INCFG = 1 - No interrupt on GPIO transition"]
    #[inline(always)]
    pub fn intdis(self) -> &'a mut W {
        self.variant(GPIO5INTD_A::INTDIS)
    }
    #[doc = "Applies when GPIO5INCFG = 1 - Interrupt on either low to high or high to low GPIO transition"]
    #[inline(always)]
    pub fn intboth(self) -> &'a mut W {
...
pub enum GPIO5OUTCFG_A {
    #[doc = "0: Applies when PAD5FNCSEL = GPIO - Output disabled"]
    DIS = 0,
    #[doc = "1: Applies when PAD5FNCSEL = GPIO - Output is push-pull"]
    PUSHPULL = 1,
    #[doc = "2: Applies when PAD5FNCSEL = GPIO - Output is open drain"]
    OD = 2,
    #[doc = "3: Applies when PAD5FNCSEL = GPIO - Output is tri-state"]
    TS = 3,
}
...
impl<'a> GPIO5OUTCFG_W<'a> {
    ...
    #[doc = "Applies when PAD5FNCSEL = GPIO - Output disabled"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(GPIO5OUTCFG_A::DIS)
    }
    #[doc = "Applies when PAD5FNCSEL = GPIO - Output is push-pull"]
    #[inline(always)]
    pub fn pushpull(self) -> &'a mut W {
        self.variant(GPIO5OUTCFG_A::PUSHPULL)
    }
    #[doc = "Applies when PAD5FNCSEL = GPIO - Output is open drain"]
    #[inline(always)]
    pub fn od(self) -> &'a mut W {
        self.variant(GPIO5OUTCFG_A::OD)
    }
    #[doc = "Applies when PAD5FNCSEL = GPIO - Output is tri-state"]
    #[inline(always)]
    pub fn ts(self) -> &'a mut W {
...
#[doc = "GPIO4 interrupt direction, nCE polarity.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum GPIO4INTD_A {
    #[doc = "0: Applies when PAD4FNCSEL = NCE4 - nCE polarity active low"]
    NCELOW = 0,
    #[doc = "1: Applies when PAD4FNCSEL = NCE4 - nCE polarity active high"]
    NCEHIGH = 1,
}
...
impl<'a> GPIO4INTD_W<'a> {
    ...
    #[doc = "Applies when PAD4FNCSEL = NCE4 - nCE polarity active low"]
    #[inline(always)]
    pub fn n_celow(self) -> &'a mut W {
        self.variant(GPIO4INTD_A::NCELOW)
    }
    #[doc = "Applies when PAD4FNCSEL = NCE4 - nCE polarity active high"]
    #[inline(always)]
    pub fn n_cehigh(self) -> &'a mut W {
...
pub enum GPIO4OUTCFG_A {
    #[doc = "0: Applies when PAD4FNCSEL = GPIO - Output disabled"]
    DIS = 0,
    #[doc = "1: Applies when PAD4FNCSEL = GPIO - Output is push-pull"]
    PUSHPULL = 1,
    #[doc = "2: Applies when PAD4FNCSEL = GPIO - Output is open drain"]
    OD = 2,
    #[doc = "3: Applies when PAD4FNCSEL = GPIO - Output is tri-state"]
    TS = 3,
}
...
impl<'a> GPIO4OUTCFG_W<'a> {
    ...
    #[doc = "Applies when PAD4FNCSEL = GPIO - Output disabled"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(GPIO4OUTCFG_A::DIS)
    }
    #[doc = "Applies when PAD4FNCSEL = GPIO - Output is push-pull"]
    #[inline(always)]
    pub fn pushpull(self) -> &'a mut W {
        self.variant(GPIO4OUTCFG_A::PUSHPULL)
    }
    #[doc = "Applies when PAD4FNCSEL = GPIO - Output is open drain"]
    #[inline(always)]
    pub fn od(self) -> &'a mut W {
        self.variant(GPIO4OUTCFG_A::OD)
    }
    #[doc = "Applies when PAD4FNCSEL = GPIO - Output is tri-state"]
    #[inline(always)]
    pub fn ts(self) -> &'a mut W {
...
#[doc = "GPIO3 interrupt direction, nCE polarity.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum GPIO3INTD_A {
    #[doc = "0: Applies when PAD3FNCSEL = NCE3 - nCE polarity active low"]
    NCELOW = 0,
    #[doc = "1: Applies when PAD3FNCSEL = NCE3 - nCE polarity active high"]
    NCEHIGH = 1,
}
...
impl<'a> GPIO3INTD_W<'a> {
    ...
    #[doc = "Applies when PAD3FNCSEL = NCE3 - nCE polarity active low"]
    #[inline(always)]
    pub fn n_celow(self) -> &'a mut W {
        self.variant(GPIO3INTD_A::NCELOW)
    }
    #[doc = "Applies when PAD3FNCSEL = NCE3 - nCE polarity active high"]
    #[inline(always)]
    pub fn n_cehigh(self) -> &'a mut W {
...
pub enum GPIO3OUTCFG_A {
    #[doc = "0: Applies when PAD3FNCSEL = GPIO - Output disabled"]
    DIS = 0,
    #[doc = "1: Applies when PAD3FNCSEL = GPIO - Output is push-pull"]
    PUSHPULL = 1,
    #[doc = "2: Applies when PAD3FNCSEL = GPIO - Output is open drain"]
    OD = 2,
    #[doc = "3: Applies when PAD3FNCSEL = GPIO - Output is tri-state"]
    TS = 3,
}
...
impl<'a> GPIO3OUTCFG_W<'a> {
    ...
    #[doc = "Applies when PAD3FNCSEL = GPIO - Output disabled"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(GPIO3OUTCFG_A::DIS)
    }
    #[doc = "Applies when PAD3FNCSEL = GPIO - Output is push-pull"]
    #[inline(always)]
    pub fn pushpull(self) -> &'a mut W {
        self.variant(GPIO3OUTCFG_A::PUSHPULL)
    }
    #[doc = "Applies when PAD3FNCSEL = GPIO - Output is open drain"]
    #[inline(always)]
    pub fn od(self) -> &'a mut W {
        self.variant(GPIO3OUTCFG_A::OD)
    }
    #[doc = "Applies when PAD3FNCSEL = GPIO - Output is tri-state"]
    #[inline(always)]
    pub fn ts(self) -> &'a mut W {
...
#[doc = "GPIO2 interrupt direction, nCE polarity.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum GPIO2INTD_A {
    #[doc = "0: Applies when PAD2FNCSEL = NCE2 - nCE polarity active low"]
    NCELOW = 0,
    #[doc = "1: Applies when PAD2FNCSEL = NCE2 - nCE polarity active high"]
    NCEHIGH = 1,
}
...
impl<'a> GPIO2INTD_W<'a> {
    ...
    #[doc = "Applies when PAD2FNCSEL = NCE2 - nCE polarity active low"]
    #[inline(always)]
    pub fn n_celow(self) -> &'a mut W {
        self.variant(GPIO2INTD_A::NCELOW)
    }
    #[doc = "Applies when PAD2FNCSEL = NCE2 - nCE polarity active high"]
    #[inline(always)]
    pub fn n_cehigh(self) -> &'a mut W {
...
pub enum GPIO2OUTCFG_A {
    #[doc = "0: Applies when PAD2FNCSEL = GPIO - Output disabled"]
    DIS = 0,
    #[doc = "1: Applies when PAD2FNCSEL = GPIO - Output is push-pull"]
    PUSHPULL = 1,
    #[doc = "2: Applies when PAD2FNCSEL = GPIO - Output is open drain"]
    OD = 2,
    #[doc = "3: Applies when PAD2FNCSEL = GPIO - Output is tri-state"]
    TS = 3,
}
...
impl<'a> GPIO2OUTCFG_W<'a> {
    ...
    #[doc = "Applies when PAD2FNCSEL = GPIO - Output disabled"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(GPIO2OUTCFG_A::DIS)
    }
    #[doc = "Applies when PAD2FNCSEL = GPIO - Output is push-pull"]
    #[inline(always)]
    pub fn pushpull(self) -> &'a mut W {
        self.variant(GPIO2OUTCFG_A::PUSHPULL)
    }
    #[doc = "Applies when PAD2FNCSEL = GPIO - Output is open drain"]
    #[inline(always)]
    pub fn od(self) -> &'a mut W {
        self.variant(GPIO2OUTCFG_A::OD)
    }
    #[doc = "Applies when PAD2FNCSEL = GPIO - Output is tri-state"]
    #[inline(always)]
    pub fn ts(self) -> &'a mut W {
...
#[doc = "GPIO1 interrupt direction, nCE polarity.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum GPIO1INTD_A {
    #[doc = "0: Applies when PAD1FNCSEL = NCE1 - nCE polarity active low"]
    NCELOW = 0,
    #[doc = "1: Applies when PAD1FNCSEL = NCE1 - nCE polarity active high"]
    NCEHIGH = 1,
}
...
impl<'a> GPIO1INTD_W<'a> {
    ...
    #[doc = "Applies when PAD1FNCSEL = NCE1 - nCE polarity active low"]
    #[inline(always)]
    pub fn n_celow(self) -> &'a mut W {
        self.variant(GPIO1INTD_A::NCELOW)
    }
    #[doc = "Applies when PAD1FNCSEL = NCE1 - nCE polarity active high"]
    #[inline(always)]
    pub fn n_cehigh(self) -> &'a mut W {
...
pub enum GPIO1OUTCFG_A {
    #[doc = "0: Applies when PAD1FNCSEL = GPIO - Output disabled"]
    DIS = 0,
    #[doc = "1: Applies when PAD1FNCSEL = GPIO - Output is push-pull"]
    PUSHPULL = 1,
    #[doc = "2: Applies when PAD1FNCSEL = GPIO - Output is open drain"]
    OD = 2,
    #[doc = "3: Applies when PAD1FNCSEL = GPIO - Output is tri-state"]
    TS = 3,
}
...
impl<'a> GPIO1OUTCFG_W<'a> {
    ...
    #[doc = "Applies when PAD1FNCSEL = GPIO - Output disabled"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(GPIO1OUTCFG_A::DIS)
    }
    #[doc = "Applies when PAD1FNCSEL = GPIO - Output is push-pull"]
    #[inline(always)]
    pub fn pushpull(self) -> &'a mut W {
        self.variant(GPIO1OUTCFG_A::PUSHPULL)
    }
    #[doc = "Applies when PAD1FNCSEL = GPIO - Output is open drain"]
    #[inline(always)]
    pub fn od(self) -> &'a mut W {
        self.variant(GPIO1OUTCFG_A::OD)
    }
    #[doc = "Applies when PAD1FNCSEL = GPIO - Output is tri-state"]
    #[inline(always)]
    pub fn ts(self) -> &'a mut W {
...
#[doc = "GPIO0 interrupt direction, nCE polarity.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum GPIO0INTD_A {
    #[doc = "0: Applies when PAD0FNCSEL = NCE0 - nCE polarity active low"]
    NCELOW = 0,
    #[doc = "1: Applies when PAD0FNCSEL = NCE0 - nCE polarity active high"]
    NCEHIGH = 1,
}
...
impl<'a> GPIO0INTD_W<'a> {
    ...
    #[doc = "Applies when PAD0FNCSEL = NCE0 - nCE polarity active low"]
    #[inline(always)]
    pub fn n_celow(self) -> &'a mut W {
        self.variant(GPIO0INTD_A::NCELOW)
    }
    #[doc = "Applies when PAD0FNCSEL = NCE0 - nCE polarity active high"]
    #[inline(always)]
    pub fn n_cehigh(self) -> &'a mut W {
...
pub enum GPIO0OUTCFG_A {
    #[doc = "0: Applies when PAD0FNCSEL = GPIO - Output disabled"]
    DIS = 0,
    #[doc = "1: Applies when PAD0FNCSEL = GPIO - Output is push-pull"]
    PUSHPULL = 1,
    #[doc = "2: Applies when PAD0FNCSEL = GPIO - Output is open drain"]
    OD = 2,
    #[doc = "3: Applies when PAD0FNCSEL = GPIO - Output is tri-state"]
    TS = 3,
}
...
impl<'a> GPIO0OUTCFG_W<'a> {
    ...
    #[doc = "Applies when PAD0FNCSEL = GPIO - Output disabled"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(GPIO0OUTCFG_A::DIS)
    }
    #[doc = "Applies when PAD0FNCSEL = GPIO - Output is push-pull"]
    #[inline(always)]
    pub fn pushpull(self) -> &'a mut W {
        self.variant(GPIO0OUTCFG_A::PUSHPULL)
    }
    #[doc = "Applies when PAD0FNCSEL = GPIO - Output is open drain"]
    #[inline(always)]
    pub fn od(self) -> &'a mut W {
        self.variant(GPIO0OUTCFG_A::OD)
    }
    #[doc = "Applies when PAD0FNCSEL = GPIO - Output is tri-state"]
    #[inline(always)]
    pub fn ts(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 27 - GPIO6 interrupt direction, nCE polarity."]
    #[inline(always)]
    ...
    #[doc = "Bit 23 - GPIO5 interrupt direction, nCE polarity."]
    #[inline(always)]
    ...
    #[doc = "Bit 19 - GPIO4 interrupt direction, nCE polarity."]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - GPIO3 interrupt direction, nCE polarity."]
    #[inline(always)]
    ...
    #[doc = "Bit 11 - GPIO2 interrupt direction, nCE polarity."]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - GPIO1 interrupt direction, nCE polarity."]
    #[inline(always)]
    ...
    #[doc = "Bit 3 - GPIO0 interrupt direction, nCE polarity."]
    #[inline(always)]
