...
pub enum PAD47FNCSEL_A {
    ...
    _32KHZXT = 0,
    #[doc = "1: IOM/MSPI nCE group 47"]
    NCE47 = 1,
    #[doc = "2: CTIMER connection 26"]
    CT26 = 2,
...
pub enum PAD46FNCSEL_A {
    #[doc = "0: Configure as the 32kHz output clock from the crystal"]
    _32KHZ_XT = 0,
    #[doc = "1: IOM/MSPI nCE group 46"]
    NCE46 = 1,
    #[doc = "2: CTIMER connection 24"]
    CT24 = 2,
