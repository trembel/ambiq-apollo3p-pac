...
impl R {
    #[doc = "Bits 0:15 - Sample of the data output on the GPIO observation port. May have sampling non-synchronization issues, as the data is not synchronized to the read operation. Intended for debug purposes only"]
    #[inline(always)]
