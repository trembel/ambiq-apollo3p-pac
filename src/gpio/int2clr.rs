#[doc = "Reader of register INT2CLR"]
pub type R = crate::R<u32, super::INT2CLR>;
#[doc = "Writer for register INT2CLR"]
pub type W = crate::W<u32, super::INT2CLR>;
#[doc = "Register INT2CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::INT2CLR {
    type Type = u32;
    #[inline(always)]
