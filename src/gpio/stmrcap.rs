...
impl R {
    #[doc = "Bit 31 - STIMER Capture 3 Polarity."]
    #[inline(always)]
    pub fn stpol3(&self) -> STPOL3_R {
        STPOL3_R::new(((self.bits >> 31) & 0x01) != 0)
    }
    #[doc = "Bits 24:30 - STIMER Capture 3 Select."]
    #[inline(always)]
    pub fn stsel3(&self) -> STSEL3_R {
        STSEL3_R::new(((self.bits >> 24) & 0x7f) as u8)
    }
    #[doc = "Bit 23 - STIMER Capture 2 Polarity."]
    #[inline(always)]
    pub fn stpol2(&self) -> STPOL2_R {
        STPOL2_R::new(((self.bits >> 23) & 0x01) != 0)
    }
    #[doc = "Bits 16:22 - STIMER Capture 2 Select."]
    #[inline(always)]
    pub fn stsel2(&self) -> STSEL2_R {
        STSEL2_R::new(((self.bits >> 16) & 0x7f) as u8)
    }
    #[doc = "Bit 15 - STIMER Capture 1 Polarity."]
    #[inline(always)]
    pub fn stpol1(&self) -> STPOL1_R {
        STPOL1_R::new(((self.bits >> 15) & 0x01) != 0)
    }
    #[doc = "Bits 8:14 - STIMER Capture 1 Select."]
    #[inline(always)]
    pub fn stsel1(&self) -> STSEL1_R {
        STSEL1_R::new(((self.bits >> 8) & 0x7f) as u8)
    }
    #[doc = "Bit 7 - STIMER Capture 0 Polarity."]
    #[inline(always)]
    pub fn stpol0(&self) -> STPOL0_R {
        STPOL0_R::new(((self.bits >> 7) & 0x01) != 0)
    }
    #[doc = "Bits 0:6 - STIMER Capture 0 Select."]
    #[inline(always)]
    pub fn stsel0(&self) -> STSEL0_R {
        STSEL0_R::new((self.bits & 0x7f) as u8)
    }
}
impl W {
    #[doc = "Bit 31 - STIMER Capture 3 Polarity."]
