...
pub enum PAD6FNCSEL_A {
    #[doc = "0: Configure as the IOMSTR0 I2C SDA or SPI WIR3 signal"]
    M0SDAWIR3 = 0,
...
impl<'a> PAD6FNCSEL_W<'a> {
    ...
    #[doc = "Configure as the IOMSTR0 I2C SDA or SPI WIR3 signal"]
    #[inline(always)]
...
pub enum PAD4FNCSEL_A {
    ...
    SLINT = 1,
    #[doc = "2: IOM/SPI nCE group 4"]
    NCE4 = 2,
    #[doc = "3: Configure as GPIO4"]
    GPIO4 = 3,
    #[doc = "5: Configure as the UART0 RX input"]
    UART0RX = 5,
    #[doc = "6: CTIMER connection 17"]
    CT17 = 6,
    #[doc = "7: MSPI data connection 2"]
    MSPI2 = 7,
}
