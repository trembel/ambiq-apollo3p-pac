...
#[repr(u8)]
pub enum CONFIG_A {
    #[doc = "4: Direct mapped, 128-bit line size, 512 entries (4 SRAMs active)"]
    W1_128B_512E = 4,
    #[doc = "5: Two-way set associative, 128-bit line size, 512 entries (8 SRAMs active)"]
    W2_128B_512E = 5,
    #[doc = "8: Direct mapped, 128-bit line size, 1024 entries (8 SRAMs active)"]
    W1_128B_1024E = 8,
}
...
impl<'a> CONFIG_W<'a> {
    ...
    #[doc = "Direct mapped, 128-bit line size, 512 entries (4 SRAMs active)"]
    #[inline(always)]
    pub fn w1_128b_512e(self) -> &'a mut W {
        self.variant(CONFIG_A::W1_128B_512E)
    }
    #[doc = "Two-way set associative, 128-bit line size, 512 entries (8 SRAMs active)"]
    #[inline(always)]
    pub fn w2_128b_512e(self) -> &'a mut W {
        self.variant(CONFIG_A::W2_128B_512E)
    }
    #[doc = "Direct mapped, 128-bit line size, 1024 entries (8 SRAMs active)"]
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 1 - Sets the cache replacement policy. 0=LRR (least recently replaced), 1=LRU (least recently used). LRR minimizes writes to the TAG SRAM."]
    #[inline(always)]
