...
#[doc = "Sets the I2C master device address size to either 7 bits (0) or 10 bits (1).\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ADDRSZ_A {
    #[doc = "0: Use 7-bit addressing for I2C master transactions"]
    ADDRSZ7 = 0,
    #[doc = "1: Use 10-bit addressing for I2C master transactions"]
    ADDRSZ10 = 1,
}
...
impl<'a> ADDRSZ_W<'a> {
    ...
    #[doc = "Use 7-bit addressing for I2C master transactions"]
    #[inline(always)]
    pub fn addrsz7(self) -> &'a mut W {
        self.variant(ADDRSZ_A::ADDRSZ7)
    }
    #[doc = "Use 10-bit addressing for I2C master transactions"]
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 16:23 - Number of Base clock cycles to wait before sampling the SCL clock to determine if a clock stretch event has occurred"]
    #[inline(always)]
    ...
    #[doc = "Bit 0 - Sets the I2C master device address size to either 7 bits (0) or 10 bits (1)."]
    #[inline(always)]
