...
pub enum CQPEN_A {
    ...
    GPIOXOREN = 4096,
    #[doc = "2048: Pause command queue when selected MSPI input bit 1 (buffer 1 ready) XNORed with SWFLAG1 is '1'. MSPI used is selected in CQCFG.MSPIFLGSEL field."]
    MSPI1XNOREN = 2048,
    #[doc = "1024: Pause command queue when selected MSPI input bit 0 (buffer 0 ready) XNORed with SWFLAG1 is '1'. MSPI used is selected in CQCFG.MSPIFLGSEL field."]
    MSPI0XNOREN = 1024,
    #[doc = "512: Pause command queue when selected MSPI input bit 1 (buffer 1 ready) XORed with SWFLAG1 is '1'. MSPI used is selected in CQCFG.MSPIFLGSEL field."]
    MSPI1XOREN = 512,
    #[doc = "256: Pause command queue when selected MSPI input bit 0 (buffer 0 ready) XORed with SWFLAG1 is '1'. MSPI used is selected in CQCFG.MSPIFLGSEL field."]
    MSPI0XOREN = 256,
...
impl<'a> CQPEN_W<'a> {
    ...
    #[doc = "Pause command queue when selected MSPI input bit 1 (buffer 1 ready) XNORed with SWFLAG1 is '1'. MSPI used is selected in CQCFG.MSPIFLGSEL field."]
    #[inline(always)]
    pub fn mspi1xnoren(self) -> &'a mut W {
        self.variant(CQPEN_A::MSPI1XNOREN)
    }
    #[doc = "Pause command queue when selected MSPI input bit 0 (buffer 0 ready) XNORed with SWFLAG1 is '1'. MSPI used is selected in CQCFG.MSPIFLGSEL field."]
    #[inline(always)]
    pub fn mspi0xnoren(self) -> &'a mut W {
        self.variant(CQPEN_A::MSPI0XNOREN)
    }
    #[doc = "Pause command queue when selected MSPI input bit 1 (buffer 1 ready) XORed with SWFLAG1 is '1'. MSPI used is selected in CQCFG.MSPIFLGSEL field."]
    #[inline(always)]
    pub fn mspi1xoren(self) -> &'a mut W {
        self.variant(CQPEN_A::MSPI1XOREN)
    }
    #[doc = "Pause command queue when selected MSPI input bit 0 (buffer 0 ready) XORed with SWFLAG1 is '1'. MSPI used is selected in CQCFG.MSPIFLGSEL field."]
    #[inline(always)]
