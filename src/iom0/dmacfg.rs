...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DMADIR_A {
    #[doc = "0: Peripheral to Memory (SRAM) transaction. To be set when doing IOM read operations, i.e., reading data from external devices."]
    P2M = 0,
    #[doc = "1: Memory to Peripheral transaction. To be set when doing IOM write operations, i.e., writing data to external devices."]
    M2P = 1,
}
...
impl<'a> DMADIR_W<'a> {
    ...
    #[doc = "Peripheral to Memory (SRAM) transaction. To be set when doing IOM read operations, i.e., reading data from external devices."]
    #[inline(always)]
    pub fn p2m(self) -> &'a mut W {
        self.variant(DMADIR_A::P2M)
    }
    #[doc = "Memory to Peripheral transaction. To be set when doing IOM write operations, i.e., writing data to external devices."]
    #[inline(always)]
