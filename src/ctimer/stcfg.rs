...
#[doc = "Selects whether compare is enabled for the corresponding SCMPR register. If compare is enabled, the interrupt status is set once the comparison is met.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
...
impl R {
    ...
    #[doc = "Bit 15 - Selects whether compare is enabled for the corresponding SCMPR register. If compare is enabled, the interrupt status is set once the comparison is met."]
    #[inline(always)]
    pub fn compare_h_en(&self) -> COMPARE_H_EN_R {
        COMPARE_H_EN_R::new(((self.bits >> 15) & 0x01) != 0)
    }
    #[doc = "Bit 14 - Selects whether compare is enabled for the corresponding SCMPR register. If compare is enabled, the interrupt status is set once the comparison is met."]
    #[inline(always)]
    pub fn compare_g_en(&self) -> COMPARE_G_EN_R {
        COMPARE_G_EN_R::new(((self.bits >> 14) & 0x01) != 0)
    }
    #[doc = "Bit 13 - Selects whether compare is enabled for the corresponding SCMPR register. If compare is enabled, the interrupt status is set once the comparison is met."]
    #[inline(always)]
    pub fn compare_f_en(&self) -> COMPARE_F_EN_R {
        COMPARE_F_EN_R::new(((self.bits >> 13) & 0x01) != 0)
    }
    #[doc = "Bit 12 - Selects whether compare is enabled for the corresponding SCMPR register. If compare is enabled, the interrupt status is set once the comparison is met."]
    #[inline(always)]
    pub fn compare_e_en(&self) -> COMPARE_E_EN_R {
        COMPARE_E_EN_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    #[doc = "Bit 11 - Selects whether compare is enabled for the corresponding SCMPR register. If compare is enabled, the interrupt status is set once the comparison is met."]
    #[inline(always)]
    pub fn compare_d_en(&self) -> COMPARE_D_EN_R {
        COMPARE_D_EN_R::new(((self.bits >> 11) & 0x01) != 0)
    }
    #[doc = "Bit 10 - Selects whether compare is enabled for the corresponding SCMPR register. If compare is enabled, the interrupt status is set once the comparison is met."]
    #[inline(always)]
    pub fn compare_c_en(&self) -> COMPARE_C_EN_R {
        COMPARE_C_EN_R::new(((self.bits >> 10) & 0x01) != 0)
    }
    #[doc = "Bit 9 - Selects whether compare is enabled for the corresponding SCMPR register. If compare is enabled, the interrupt status is set once the comparison is met."]
    #[inline(always)]
    pub fn compare_b_en(&self) -> COMPARE_B_EN_R {
        COMPARE_B_EN_R::new(((self.bits >> 9) & 0x01) != 0)
    }
    #[doc = "Bit 8 - Selects whether compare is enabled for the corresponding SCMPR register. If compare is enabled, the interrupt status is set once the comparison is met."]
    #[inline(always)]
