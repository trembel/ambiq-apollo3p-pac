...
pub enum TMRB5FN_A {
    ...
    PULSE_ONCE = 2,
    #[doc = "3: Pulse continuously. Count to CMPR0B5, assert, count to CMPR1B5, deassert, restart."]
    PULSE_CONT = 3,
...
impl<'a> TMRB5FN_W<'a> {
    ...
    #[doc = "Pulse continuously. Count to CMPR0B5, assert, count to CMPR1B5, deassert, restart."]
    #[inline(always)]
...
pub enum TMRA5FN_A {
    ...
    PULSE_ONCE = 2,
    #[doc = "3: Pulse continuously. Count to CMPR0A5, assert, count to CMPR1A5, deassert, restart."]
    PULSE_CONT = 3,
    #[doc = "4: Single pattern."]
    SINGLEPATTERN = 4,
    #[doc = "5: Repeated pattern."]
...
impl<'a> TMRA5FN_W<'a> {
    ...
    #[doc = "Pulse continuously. Count to CMPR0A5, assert, count to CMPR1A5, deassert, restart."]
    #[inline(always)]
    pub fn pulse_cont(self) -> &'a mut W {
