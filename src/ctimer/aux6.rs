...
pub enum TMRB6TRIG_A {
    ...
    DIS = 0,
    #[doc = "1: Trigger source is CTIMERA6 OUT."]
    A6OUT = 1,
    ...
    A7OUT2DUAL = 13,
    #[doc = "14: Trigger source is CTIMERB0 OUT2, dual edge."]
    B0OUT2DUAL = 14,
    #[doc = "15: Trigger source is CTIMERA0 OUT2, dual edge."]
    A0OUT2DUAL = 15,
}
...
impl<'a> TMRB6TRIG_W<'a> {
    ...
    #[doc = "Trigger source is CTIMERB0 OUT2, dual edge."]
    #[inline(always)]
    pub fn b0out2dual(self) -> &'a mut W {
        self.variant(TMRB6TRIG_A::B0OUT2DUAL)
    }
    #[doc = "Trigger source is CTIMERA0 OUT2, dual edge."]
    #[inline(always)]
...
pub enum TMRA6TRIG_A {
    #[doc = "0: Trigger source is disabled."]
    DIS = 0,
    #[doc = "1: Trigger source is CTIMERB6 OUT."]
    B6OUT = 1,
    #[doc = "2: Trigger source is CTIMERB3 OUT."]
    B3OUT = 2,
    #[doc = "3: Trigger source is CTIMERA3 OUT."]
    ...
    #[doc = "10: Trigger source is CTIMERA2 OUT2."]
    A2OUT2 = 10,
    #[doc = "11: Trigger source is CTIMERBb OUT2."]
    B2OUT2 = 11,
    #[doc = "12: Trigger source is CTIMERA5 OUT2, dual edge."]
    A5OUT2DUAL = 12,
    #[doc = "13: Trigger source is CTIMERA7 OUT2, dual edge."]
    A7OUT2DUAL = 13,
    #[doc = "14: Trigger source is CTIMERB0 OUT2, dual edge."]
...
impl<'a> TMRA6TRIG_W<'a> {
    ...
    #[doc = "Trigger source is CTIMERBb OUT2."]
    #[inline(always)]
    pub fn b2out2(self) -> &'a mut W {
