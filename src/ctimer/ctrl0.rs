...
pub enum TMRB0FN_A {
    ...
    PULSE_ONCE = 2,
    #[doc = "3: Pulse continuously. Count to CMPR0B0, assert, count to CMPR1B0, deassert, restart."]
    PULSE_CONT = 3,
...
impl<'a> TMRB0FN_W<'a> {
    ...
    #[doc = "Pulse continuously. Count to CMPR0B0, assert, count to CMPR1B0, deassert, restart."]
    #[inline(always)]
...
pub enum TMRA0FN_A {
    ...
    PULSE_ONCE = 2,
    #[doc = "3: Pulse continuously. Count to CMPR0A0, assert, count to CMPR1A0, deassert, restart."]
    PULSE_CONT = 3,
    #[doc = "4: Single pattern."]
    SINGLEPATTERN = 4,
    #[doc = "5: Repeated pattern."]
...
impl<'a> TMRA0FN_W<'a> {
    ...
    #[doc = "Pulse continuously. Count to CMPR0A0, assert, count to CMPR1A0, deassert, restart."]
    #[inline(always)]
    pub fn pulse_cont(self) -> &'a mut W {
