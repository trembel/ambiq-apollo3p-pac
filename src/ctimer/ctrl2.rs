...
pub enum TMRB2FN_A {
    ...
    PULSE_ONCE = 2,
    #[doc = "3: Pulse continuously. Count to CMPR0B2, assert, count to CMPR1B2, deassert, restart."]
    PULSE_CONT = 3,
...
impl<'a> TMRB2FN_W<'a> {
    ...
    #[doc = "Pulse continuously. Count to CMPR0B2, assert, count to CMPR1B2, deassert, restart."]
    #[inline(always)]
...
pub enum TMRA2FN_A {
    ...
    PULSE_ONCE = 2,
    #[doc = "3: Pulse continuously. Count to CMPR0A2, assert, count to CMPR1A2, deassert, restart."]
    PULSE_CONT = 3,
    #[doc = "4: Single pattern."]
    SINGLEPATTERN = 4,
    #[doc = "5: Repeated pattern."]
...
impl<'a> TMRA2FN_W<'a> {
    ...
    #[doc = "Pulse continuously. Count to CMPR0A2, assert, count to CMPR1A2, deassert, restart."]
    #[inline(always)]
    pub fn pulse_cont(self) -> &'a mut W {
