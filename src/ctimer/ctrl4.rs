...
pub enum TMRB4FN_A {
    ...
    PULSE_ONCE = 2,
    #[doc = "3: Pulse continuously. Count to CMPR0B4, assert, count to CMPR1B4, deassert, restart."]
    PULSE_CONT = 3,
...
impl<'a> TMRB4FN_W<'a> {
    ...
    #[doc = "Pulse continuously. Count to CMPR0B4, assert, count to CMPR1B4, deassert, restart."]
    #[inline(always)]
...
pub enum TMRA4FN_A {
    ...
    PULSE_ONCE = 2,
    #[doc = "3: Pulse continuously. Count to CMPR0A4, assert, count to CMPR1A4, deassert, restart."]
    PULSE_CONT = 3,
    #[doc = "4: Single pattern."]
    SINGLEPATTERN = 4,
    #[doc = "5: Repeated pattern."]
...
impl<'a> TMRA4FN_W<'a> {
    ...
    #[doc = "Pulse continuously. Count to CMPR0A4, assert, count to CMPR1A4, deassert, restart."]
    #[inline(always)]
    pub fn pulse_cont(self) -> &'a mut W {
