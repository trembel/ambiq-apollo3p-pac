...
pub enum CFG18_A {
    ...
    A3OUT2 = 5,
    #[doc = "4: Output is A0OUT."]
    A0OUT = 4,
    #[doc = "3: Output is B0OUT."]
    B0OUT = 3,
    #[doc = "2: Output is B4OUT"]
    B4OUT = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
...
pub enum CFG17_A {
    ...
    A4OUT = 4,
    #[doc = "3: Output is B7OUT."]
    B7OUT = 3,
    #[doc = "2: Output is A4OUT2"]
    A4OUT2 = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
...
pub enum CFG16_A {
    ...
    #[doc = "6: Output is A6OUT2."]
    A6OUT2 = 6,
    #[doc = "5: Output is B3OUT2."]
    B3OUT2 = 5,
    #[doc = "4: Output is A0OUT2."]
    A0OUT2 = 4,
    #[doc = "3: Output is A0OUT."]
    A0OUT = 3,
    #[doc = "2: Output is A4OUT"]
    A4OUT = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
...
pub enum CFG15_A {
    ...
    #[doc = "6: Output is A6OUT2."]
    A6OUT2 = 6,
    #[doc = "5: Output is A4OUT2."]
    A4OUT2 = 5,
    #[doc = "4: Output is A7OUT."]
    A7OUT = 4,
    #[doc = "3: Output is B3OUT."]
    B3OUT = 3,
    #[doc = "2: Output is B3OUT2"]
    B3OUT2 = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
...
pub enum CFG14_A {
    ...
    A7OUT = 5,
    #[doc = "4: Output is B7OUT2."]
    B7OUT2 = 4,
    #[doc = "3: Output is B1OUT."]
    B1OUT = 3,
    #[doc = "2: Output is B3OUT"]
    B3OUT = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
...
pub enum CFG13_A {
    ...
    #[doc = "6: Output is A6OUT2."]
    A6OUT2 = 6,
    #[doc = "5: Output is B4OUT2."]
    B4OUT2 = 5,
    #[doc = "4: Output is A6OUT."]
    A6OUT = 4,
    #[doc = "3: Output is A3OUT."]
    A3OUT = 3,
    #[doc = "2: Output is A3OUT2"]
    A3OUT2 = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
...
pub enum CFG12_A {
    ...
    #[doc = "6: Output is A6OUT2."]
    A6OUT2 = 6,
    #[doc = "5: Output is B6OUT2."]
    B6OUT2 = 5,
    #[doc = "4: Output is B0OUT2."]
    B0OUT2 = 4,
    #[doc = "3: Output is B1OUT."]
    B1OUT = 3,
    #[doc = "2: Output is A3OUT"]
    A3OUT = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
...
pub enum CFG11_A {
    ...
    #[doc = "6: Output is A6OUT2."]
    A6OUT2 = 6,
    #[doc = "5: Output is B5OUT2."]
    B5OUT2 = 5,
    #[doc = "4: Output is B4OUT."]
    B4OUT = 4,
    #[doc = "3: Output is B2OUT."]
    B2OUT = 3,
    #[doc = "2: Output is B2OUT2"]
    B2OUT2 = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
...
pub enum CFG10_A {
    ...
    A6OUT = 5,
    #[doc = "4: Output is B4OUT2."]
    B4OUT2 = 4,
    #[doc = "3: Output is B3OUT2."]
    B3OUT2 = 3,
    #[doc = "2: Output is B2OUT"]
    B2OUT = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
