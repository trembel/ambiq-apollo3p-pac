...
pub enum TMRB3TRIG_A {
    ...
    DIS = 0,
    #[doc = "1: Trigger source is CTIMERA3 OUT."]
    A3OUT = 1,
    #[doc = "2: Trigger source is CTIMERB2 OUT."]
    B2OUT = 2,
    #[doc = "3: Trigger source is CTIMERA2 OUT."]
    A2OUT = 3,
    #[doc = "4: Trigger source is CTIMERA4 OUT."]
    A4OUT = 4,
    #[doc = "5: Trigger source is CTIMERB4 OUT."]
    B4OUT = 5,
    #[doc = "6: Trigger source is CTIMERA6 OUT."]
    A6OUT = 6,
    #[doc = "7: Trigger source is CTIMERB6 OUT."]
    B6OUT = 7,
    #[doc = "8: Trigger source is CTIMERB5 OUT2."]
    B5OUT2 = 8,
    #[doc = "9: Trigger source is CTIMERA5 OUT2."]
    A5OUT2 = 9,
    ...
    A7OUT2DUAL = 13,
    #[doc = "14: Trigger source is CTIMERB2 OUT2, dual edge."]
    B2OUT2DUAL = 14,
    #[doc = "15: Trigger source is CTIMERA2 OUT2, dual edge."]
    A2OUT2DUAL = 15,
}
...
impl<'a> TMRB3TRIG_W<'a> {
    ...
    #[doc = "Trigger source is CTIMERB5 OUT2."]
    #[inline(always)]
    pub fn b5out2(self) -> &'a mut W {
        self.variant(TMRB3TRIG_A::B5OUT2)
    }
    #[doc = "Trigger source is CTIMERA5 OUT2."]
    #[inline(always)]
    ...
    #[doc = "Trigger source is CTIMERB2 OUT2, dual edge."]
    #[inline(always)]
    pub fn b2out2dual(self) -> &'a mut W {
        self.variant(TMRB3TRIG_A::B2OUT2DUAL)
    }
    #[doc = "Trigger source is CTIMERA2 OUT2, dual edge."]
    #[inline(always)]
...
pub enum TMRA3TRIG_A {
    #[doc = "0: Trigger source is disabled."]
    DIS = 0,
    #[doc = "1: Trigger source is CTIMERB3 OUT."]
    B3OUT = 1,
    #[doc = "2: Trigger source is CTIMERB2 OUT."]
    B2OUT = 2,
    #[doc = "3: Trigger source is CTIMERA2 OUT."]
    ...
    #[doc = "5: Trigger source is CTIMERB4 OUT."]
    B4OUT = 5,
    #[doc = "6: Trigger source is CTIMERA7 OUT."]
    A7OUT = 6,
    #[doc = "7: Trigger source is CTIMERB7 OUT."]
    B7OUT = 7,
    #[doc = "8: Trigger source is CTIMERB5 OUT2."]
    B5OUT2 = 8,
    #[doc = "9: Trigger source is CTIMERA5 OUT2."]
