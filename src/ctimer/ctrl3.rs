...
pub enum TMRB3FN_A {
    ...
    PULSE_ONCE = 2,
    #[doc = "3: Pulse continuously. Count to CMPR0B3, assert, count to CMPR1B3, deassert, restart."]
    PULSE_CONT = 3,
...
impl<'a> TMRB3FN_W<'a> {
    ...
    #[doc = "Pulse continuously. Count to CMPR0B3, assert, count to CMPR1B3, deassert, restart."]
    #[inline(always)]
...
pub enum TMRA3FN_A {
    ...
    PULSE_ONCE = 2,
    #[doc = "3: Pulse continuously. Count to CMPR0A3, assert, count to CMPR1A3, deassert, restart."]
    PULSE_CONT = 3,
    #[doc = "4: Single pattern."]
    SINGLEPATTERN = 4,
    #[doc = "5: Repeated pattern."]
...
impl<'a> TMRA3FN_W<'a> {
    ...
    #[doc = "Pulse continuously. Count to CMPR0A3, assert, count to CMPR1A3, deassert, restart."]
    #[inline(always)]
    pub fn pulse_cont(self) -> &'a mut W {
