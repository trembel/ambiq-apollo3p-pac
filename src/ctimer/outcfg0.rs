#[doc = "Reader of register OUTCFG0"]
pub type R = crate::R<u32, super::OUTCFG0>;
#[doc = "Writer for register OUTCFG0"]
pub type W = crate::W<u32, super::OUTCFG0>;
#[doc = "Register OUTCFG0 `reset()`'s with value 0x2492_2292"]
impl crate::ResetValue for super::OUTCFG0 {
    type Type = u32;
    #[inline(always)]
...
pub enum CFG9_A {
    ...
    A6OUT2 = 6,
    #[doc = "5: Output is B0OUT."]
    B0OUT = 5,
    #[doc = "4: Output is A4OUT."]
    A4OUT = 4,
    #[doc = "3: Output is A2OUT."]
    A2OUT = 3,
    #[doc = "2: Output is A2OUT2"]
    A2OUT2 = 2,
...
pub type CFG9_R = crate::R<u8, CFG9_A>;
impl CFG9_R {
...
pub enum CFG8_A {
    ...
    #[doc = "6: Output is A6OUT2."]
    A6OUT2 = 6,
    #[doc = "5: Output is B6OUT."]
    B6OUT = 5,
    #[doc = "4: Output is A4OUT2."]
    A4OUT2 = 4,
    #[doc = "3: Output is A3OUT."]
    A3OUT2 = 3,
    #[doc = "2: Output is A2OUT"]
    A2OUT = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
...
pub type CFG8_R = crate::R<u8, CFG8_A>;
impl CFG8_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
pub enum CFG7_A {
    ...
    #[doc = "6: Output is A6OUT2."]
    A6OUT2 = 6,
    #[doc = "5: Output is A7OUT."]
    A7OUT = 5,
    #[doc = "4: Output is B5OUT."]
    B5OUT = 4,
    #[doc = "3: Output is B1OUT."]
    B1OUT = 3,
    #[doc = "2: Output is B1OUT2"]
    B1OUT2 = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
...
pub enum CFG6_A {
    ...
    #[doc = "6: Output is A6OUT2."]
    A6OUT2 = 6,
    #[doc = "5: Output is B7OUT."]
    B7OUT = 5,
    #[doc = "4: Output is B5OUT2."]
    B5OUT2 = 4,
    #[doc = "3: Output is A1OUT."]
    A1OUT = 3,
    #[doc = "2: Output is B1OUT"]
    B1OUT = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
...
pub enum CFG4_A {
    ...
    #[doc = "6: Output is A6OUT2."]
    A6OUT2 = 6,
    #[doc = "5: Output is B5OUT."]
    B5OUT = 5,
    #[doc = "4: Output is A5OUT2."]
    A5OUT2 = 4,
    #[doc = "3: Output is A2OUT2."]
    A2OUT2 = 3,
    #[doc = "2: Output is A1OUT"]
    A1OUT = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
...
pub enum CFG3_A {
    ...
    #[doc = "6: Output is A6OUT2."]
    A6OUT2 = 6,
    #[doc = "5: Output is A6OUT."]
    A6OUT = 5,
    #[doc = "4: Output is A1OUT."]
    A1OUT = 4,
    #[doc = "3: Output is B0OUT."]
    B0OUT = 3,
    #[doc = "2: Output is B0OUT2"]
    B0OUT2 = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
...
pub enum CFG2_A {
    ...
    #[doc = "5: Output is A7OUT."]
    A7OUT = 5,
    #[doc = "4: Output is B6OUT2."]
    B6OUT2 = 4,
    #[doc = "3: Output is B1OUT2."]
    B1OUT2 = 3,
    #[doc = "2: Output is B0OUT"]
    B0OUT = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
...
pub enum CFG1_A {
    ...
    #[doc = "6: Output is A6OUT2."]
    A6OUT2 = 6,
    #[doc = "5: Output is B7OUT2."]
    B7OUT2 = 5,
    #[doc = "4: Output is A5OUT."]
    A5OUT = 4,
    #[doc = "3: Output is A0OUT."]
    A0OUT = 3,
    #[doc = "2: Output is A0OUT2"]
    A0OUT2 = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
...
pub enum CFG0_A {
    ...
    #[doc = "4: Output is A5OUT2."]
    A5OUT2 = 4,
    #[doc = "3: Output is B2OUT2."]
    B2OUT2 = 3,
    #[doc = "2: Output is A0OUT"]
    A0OUT = 2,
    #[doc = "1: Force output to 1."]
    ONE = 1,
    #[doc = "0: Force output to 0"]
