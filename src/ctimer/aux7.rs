#[doc = "Reader of register AUX7"]
pub type R = crate::R<u32, super::AUX7>;
#[doc = "Writer for register AUX7"]
pub type W = crate::W<u32, super::AUX7>;
#[doc = "Register AUX7 `reset()`'s with value 0"]
impl crate::ResetValue for super::AUX7 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `TMRB7EN23`"]
pub type TMRB7EN23_R = crate::R<bool, TMRB7EN23_A>;
impl TMRB7EN23_R {
...
#[doc = "Write proxy for field `TMRB7EN23`"]
...
#[doc = "Reader of field `TMRB7POL23`"]
pub type TMRB7POL23_R = crate::R<bool, TMRB7POL23_A>;
impl TMRB7POL23_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `TMRB7POL23`"]
...
#[doc = "Reader of field `TMRB7TINV`"]
pub type TMRB7TINV_R = crate::R<bool, TMRB7TINV_A>;
impl TMRB7TINV_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `TMRB7TINV`"]
...
#[doc = "Reader of field `TMRB7NOSYNC`"]
pub type TMRB7NOSYNC_R = crate::R<bool, TMRB7NOSYNC_A>;
impl TMRB7NOSYNC_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `TMRB7NOSYNC`"]
...
pub enum TMRB7TRIG_A {
    ...
    DIS = 0,
    #[doc = "1: Trigger source is CTIMERA7 OUT."]
    A7OUT = 1,
    #[doc = "2: Trigger source is CTIMERB3 OUT."]
    B3OUT = 2,
    #[doc = "3: Trigger source is CTIMERA3 OUT."]
    A3OUT = 3,
    #[doc = "4: Trigger source is CTIMERA5 OUT."]
    A5OUT = 4,
    ...
    A3OUT2 = 9,
    #[doc = "10: Trigger source is CTIMERA2 OUT2."]
    A2OUT2 = 10,
    #[doc = "11: Trigger source is CTIMERB2 OUT2."]
    B2OUT2 = 11,
    #[doc = "12: Trigger source is CTIMERA6 OUT2, dual edge."]
    A6OUT2DUAL = 12,
    #[doc = "13: Trigger source is CTIMERA7 OUT2, dual edge."]
    A7OUT2DUAL = 13,
    #[doc = "14: Trigger source is CTIMERB1 OUT2, dual edge."]
    B1OUT2DUAL = 14,
    #[doc = "15: Trigger source is CTIMERA1 OUT2, dual edge."]
    A1OUT2DUAL = 15,
}
...
#[doc = "Reader of field `TMRB7TRIG`"]
pub type TMRB7TRIG_R = crate::R<u8, TMRB7TRIG_A>;
impl TMRB7TRIG_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `TMRB7TRIG`"]
...
impl<'a> TMRB7TRIG_W<'a> {
    ...
    #[doc = "Trigger source is CTIMERB2 OUT2."]
    #[inline(always)]
    ...
    #[doc = "Trigger source is CTIMERB1 OUT2, dual edge."]
    #[inline(always)]
    pub fn b1out2dual(self) -> &'a mut W {
        self.variant(TMRB7TRIG_A::B1OUT2DUAL)
    }
    #[doc = "Trigger source is CTIMERA1 OUT2, dual edge."]
    #[inline(always)]
...
#[doc = "Reader of field `TMRB7LMT`"]
pub type TMRB7LMT_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `TMRB7LMT`"]
...
#[doc = "Reader of field `TMRA7EN23`"]
pub type TMRA7EN23_R = crate::R<bool, TMRA7EN23_A>;
impl TMRA7EN23_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `TMRA7EN23`"]
...
#[doc = "Reader of field `TMRA7POL23`"]
pub type TMRA7POL23_R = crate::R<bool, TMRA7POL23_A>;
impl TMRA7POL23_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `TMRA7POL23`"]
...
#[doc = "Reader of field `TMRA7TINV`"]
pub type TMRA7TINV_R = crate::R<bool, TMRA7TINV_A>;
impl TMRA7TINV_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `TMRA7TINV`"]
...
#[doc = "Reader of field `TMRA7NOSYNC`"]
pub type TMRA7NOSYNC_R = crate::R<bool, TMRA7NOSYNC_A>;
impl TMRA7NOSYNC_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `TMRA7NOSYNC`"]
...
pub enum TMRA7TRIG_A {
    #[doc = "0: Trigger source is disabled."]
    DIS = 0,
    #[doc = "1: Trigger source is CTIMERB7 OUT."]
    B7OUT = 1,
    #[doc = "2: Trigger source is CTIMERB3 OUT."]
    B3OUT = 2,
    #[doc = "3: Trigger source is CTIMERA3 OUT."]
    ...
    #[doc = "12: Trigger source is CTIMERA6 OUT2, dual edge."]
    A6OUT2DUAL = 12,
    #[doc = "13: Trigger source is CTIMERA5 OUT2, dual edge."]
    A5OUT2DUAL = 13,
...
#[doc = "Reader of field `TMRA7TRIG`"]
pub type TMRA7TRIG_R = crate::R<u8, TMRA7TRIG_A>;
impl TMRA7TRIG_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `TMRA7TRIG`"]
...
#[doc = "Reader of field `TMRA7LMT`"]
pub type TMRA7LMT_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `TMRA7LMT`"]
