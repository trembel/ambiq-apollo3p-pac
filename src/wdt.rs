...
pub struct RegisterBlock {
    ...
    #[doc = "0x200 - WDT Interrupt: Enable"]
    pub inten: INTEN,
    #[doc = "0x204 - WDT Interrupt: Status"]
    pub intstat: INTSTAT,
    #[doc = "0x208 - WDT Interrupt: Clear"]
    pub intclr: INTCLR,
    #[doc = "0x20c - WDT Interrupt: Set"]
    pub intset: INTSET,
}
