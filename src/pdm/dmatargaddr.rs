...
impl R {
    #[doc = "Bits 21:31 - SRAM Target"]
    #[inline(always)]
    pub fn utargaddr(&self) -> UTARGADDR_R {
        UTARGADDR_R::new(((self.bits >> 21) & 0x07ff) as u16)
    }
    #[doc = "Bits 0:20 - DMA Target Address. This register is not updated with the current address of the DMA, but will remain static with the original address during the DMA transfer."]
    #[inline(always)]
    pub fn ltargaddr(&self) -> LTARGADDR_R {
        LTARGADDR_R::new((self.bits & 0x001f_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 21:31 - SRAM Target"]
