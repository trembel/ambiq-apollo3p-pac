...
pub enum PWRST_A {
    ...
    INIT = 1,
    #[doc = "2: Waiting for the power-up of the BLEH"]
    PWRON = 2,
...
impl<'a> PWRST_W<'a> {
    ...
    #[doc = "Waiting for the power-up of the BLEH"]
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 7 - Status of the BLEIRQ signal from the BLE Core. A value of 1 indicates that read data is available in the core and a read operation needs to be performed."]
    #[inline(always)]
    ...
    #[doc = "Bit 5 - Value of the DCDCFLAG signal to the BLE Core. The DCDCFLAG is a signal to the BLE Core indicating that the BLEH power is active."]
    #[inline(always)]
