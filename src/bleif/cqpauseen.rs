...
#[repr(u16)]
pub enum CQPEN_A {
    #[doc = "32768: Pauses command queue processing when HWCNT matches SWCNT"]
    CNTEQ = 32768,
    ...
    SWFLAGEN7 = 128,
    #[doc = "64: Pause the command queue when software flag bit 7 is '1'"]
    SWFLAGEN6 = 64,
    #[doc = "32: Pause the command queue when software flag bit 7 is '1'"]
    SWFLAGEN5 = 32,
    #[doc = "16: Pause the command queue when software flag bit 7 is '1'"]
    SWFLAGEN4 = 16,
    #[doc = "8: Pause the command queue when software flag bit 7 is '1'"]
    SWFLAGEN3 = 8,
    #[doc = "4: Pause the command queue when software flag bit 7 is '1'"]
    SWFLAGEN2 = 4,
    #[doc = "2: Pause the command queue when software flag bit 7 is '1'"]
    SWFLAGEN1 = 2,
    #[doc = "1: Pause the command queue when software flag bit 7 is '1'"]
    SWFLGEN0 = 1,
}
...
impl<'a> CQPEN_W<'a> {
    ...
    #[doc = "Pauses command queue processing when HWCNT matches SWCNT"]
    #[inline(always)]
