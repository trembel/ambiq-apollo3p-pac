...
#[doc = "Selects the read flow control signal polarity. When set, the clock will be held low until the flow control is deasserted.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RDFCPOL_A {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SPHA_A {
    #[doc = "0: Sample on the leading (first) clock edge, rising or falling dependent on the value of SPOL"]
    SAMPLE_LEADING_EDGE = 0,
    #[doc = "1: Sample on the trailing (second) clock edge, rising of falling dependent on the value of SPOL"]
...
impl<'a> SPHA_W<'a> {
    ...
    #[doc = "Sample on the leading (first) clock edge, rising or falling dependent on the value of SPOL"]
    #[inline(always)]
    pub fn sample_leading_edge(self) -> &'a mut W {
        self.variant(SPHA_A::SAMPLE_LEADING_EDGE)
    }
    #[doc = "Sample on the trailing (second) clock edge, rising of falling dependent on the value of SPOL"]
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 22 - Selects the read flow control signal polarity. When set, the clock will be held low until the flow control is deasserted."]
    #[inline(always)]
