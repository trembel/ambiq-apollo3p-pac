...
impl R {
    ...
    #[doc = "Bit 8 - Debug control of BLEIF power state machine. Allows transition into the active state in the BLEIF state without waiting for DCDC request from BLE Core."]
    #[inline(always)]
