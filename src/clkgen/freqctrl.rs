...
pub enum BURSTREQ_A {
    #[doc = "0: Frequency for ARM core stays at 48MHz"]
    DIS = 0,
    #[doc = "1: Frequency for ARM core is increased to 96MHz"]
    EN = 1,
}
...
impl<'a> BURSTREQ_W<'a> {
    ...
    #[doc = "Frequency for ARM core stays at 48MHz"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(BURSTREQ_A::DIS)
    }
    #[doc = "Frequency for ARM core is increased to 96MHz"]
    #[inline(always)]
