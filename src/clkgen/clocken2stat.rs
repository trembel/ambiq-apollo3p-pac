...
pub enum CLOCKEN2STAT_A {
    #[doc = "1: Clock enable for the DAP"]
    DAP_CLKEN = 1,
    #[doc = "2: Clock enable for the IO MASTER 0 IFC INTERFACE"]
    IOMSTRIFC0_CLKEN = 2,
    #[doc = "4: Clock enable for the IO MASTER 1 IFC INTERFACE"]
    IOMSTRIFC1_CLKEN = 4,
    #[doc = "8: Clock enable for the IO MASTER 2 IFC INTERFACE"]
    IOMSTRIFC2_CLKEN = 8,
    #[doc = "16: Clock enable for the IO MASTER 3 IFC INTERFACE"]
    IOMSTRIFC3_CLKEN = 16,
    #[doc = "32: Clock enable for the IO MASTER 4 IFC INTERFACE"]
    IOMSTRIFC4_CLKEN = 32,
    #[doc = "64: Clock enable for the IO MASTER 5 IFC INTERFACE"]
    IOMSTRIFC5_CLKEN = 64,
    #[doc = "128: Clock enable for the PDM"]
    PDM_CLKEN = 128,
    #[doc = "256: Clock enable for the PDM INTERFACE"]
    PDMIFC_CLKEN = 256,
    #[doc = "512: Clock enable for the PWRCTRL"]
    PWRCTRL_CLKEN = 512,
    #[doc = "1024: Clock enable for the PWRCTRL counter"]
    PWRCTRL_COUNT_CLKEN = 1024,
    #[doc = "2048: Clock enable for the RSTGEN"]
    RSTGEN_CLKEN = 2048,
    #[doc = "4096: Clock enable for the SCARD"]
    SCARD_CLKEN = 4096,
    #[doc = "8192: Clock enable for the SCARD ALTAPB"]
    SCARD_ALTAPB_CLKEN = 8192,
    #[doc = "16384: Clock enable for the STIMER_CNT_CLKEN"]
    STIMER_CNT_CLKEN = 16384,
    #[doc = "32768: Clock enable for the TPIU_CLKEN"]
    TPIU_CLKEN = 32768,
    #[doc = "65536: Clock enable for the UART0 HF"]
    UART0HF_CLKEN = 65536,
    #[doc = "131072: Clock enable for the UART1 HF"]
    UART1HF_CLKEN = 131072,
    #[doc = "262144: Clock enable for the Watchdog timer"]
    WDT_CLKEN = 262144,
...
impl CLOCKEN2STAT_R {
    ...
    pub fn variant(&self) -> crate::Variant<u32, CLOCKEN2STAT_A> {
        use crate::Variant::*;
        match self.bits {
            1 => Val(CLOCKEN2STAT_A::DAP_CLKEN),
            2 => Val(CLOCKEN2STAT_A::IOMSTRIFC0_CLKEN),
            4 => Val(CLOCKEN2STAT_A::IOMSTRIFC1_CLKEN),
            8 => Val(CLOCKEN2STAT_A::IOMSTRIFC2_CLKEN),
            16 => Val(CLOCKEN2STAT_A::IOMSTRIFC3_CLKEN),
            32 => Val(CLOCKEN2STAT_A::IOMSTRIFC4_CLKEN),
            64 => Val(CLOCKEN2STAT_A::IOMSTRIFC5_CLKEN),
            128 => Val(CLOCKEN2STAT_A::PDM_CLKEN),
            256 => Val(CLOCKEN2STAT_A::PDMIFC_CLKEN),
            512 => Val(CLOCKEN2STAT_A::PWRCTRL_CLKEN),
            1024 => Val(CLOCKEN2STAT_A::PWRCTRL_COUNT_CLKEN),
            2048 => Val(CLOCKEN2STAT_A::RSTGEN_CLKEN),
            4096 => Val(CLOCKEN2STAT_A::SCARD_CLKEN),
            8192 => Val(CLOCKEN2STAT_A::SCARD_ALTAPB_CLKEN),
            16384 => Val(CLOCKEN2STAT_A::STIMER_CNT_CLKEN),
            32768 => Val(CLOCKEN2STAT_A::TPIU_CLKEN),
            65536 => Val(CLOCKEN2STAT_A::UART0HF_CLKEN),
            131072 => Val(CLOCKEN2STAT_A::UART1HF_CLKEN),
            262144 => Val(CLOCKEN2STAT_A::WDT_CLKEN),
...
impl<'a> CLOCKEN2STAT_W<'a> {
    ...
    pub fn dap_clken(self) -> &'a mut W {
        self.variant(CLOCKEN2STAT_A::DAP_CLKEN)
    }
    #[doc = "Clock enable for the IO MASTER 0 IFC INTERFACE"]
    #[inline(always)]
    pub fn iomstrifc0_clken(self) -> &'a mut W {
        self.variant(CLOCKEN2STAT_A::IOMSTRIFC0_CLKEN)
    }
    ...
    #[doc = "Clock enable for the Watchdog timer"]
    #[inline(always)]
    pub fn wdt_clken(self) -> &'a mut W {
        self.variant(CLOCKEN2STAT_A::WDT_CLKEN)
    }
