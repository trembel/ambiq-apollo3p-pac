...
#[doc = "XT warm-up period for HFRC adjustment\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum HFWARMUP_A {
    #[doc = "0: Autoadjust XT warm-up period = 1-2 seconds"]
    _1SEC = 0,
    #[doc = "1: Autoadjust XT warm-up period = 2-4 seconds"]
    _2SEC = 1,
}
...
impl<'a> HFWARMUP_W<'a> {
    ...
    #[doc = "Autoadjust XT warm-up period = 1-2 seconds"]
    #[inline(always)]
    pub fn _1sec(self) -> &'a mut W {
        self.variant(HFWARMUP_A::_1SEC)
    }
    #[doc = "Autoadjust XT warm-up period = 2-4 seconds"]
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 20 - XT warm-up period for HFRC adjustment"]
    #[inline(always)]
