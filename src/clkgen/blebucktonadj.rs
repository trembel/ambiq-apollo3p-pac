...
pub enum ZEROLENDETECTTRIM_A {
    #[doc = "15: Indicator send when the BLE BUCK asserts blebuck_comp1 for about 81 us (10 percent margin of error) or more"]
    SETF = 15,
    #[doc = "14: Indicator send when the BLE BUCK asserts blebuck_comp1 for about 75.6 us (10 percent margin of error) or more"]
    SETE = 14,
    #[doc = "13: Indicator send when the BLE BUCK asserts blebuck_comp1 for about 70.2 us (10 percent margin of error) or more"]
    SETD = 13,
    #[doc = "12: Indicator send when the BLE BUCK asserts blebuck_comp1 for about 64.8 us (10 percent margin of error) or more"]
    SETC = 12,
    #[doc = "11: Indicator send when the BLE BUCK asserts blebuck_comp1 for about 59.4 us (10 percent margin of error) or more"]
    SETB = 11,
    #[doc = "10: Indicator send when the BLE BUCK asserts blebuck_comp1 for about 54.0 us (10 percent margin of error) or more"]
    SETA = 10,
    #[doc = "9: Indicator send when the BLE BUCK asserts blebuck_comp1 for about 48.6 us (10 percent margin of error) or more"]
    SET9 = 9,
    #[doc = "8: Indicator send when the BLE BUCK asserts blebuck_comp1 for about 43.2 us (10 percent margin of error) or more"]
    SET8 = 8,
    #[doc = "7: Indicator send when the BLE BUCK asserts blebuck_comp1 for about 37.8 us (10 percent margin of error) or more"]
    SET7 = 7,
    #[doc = "6: Indicator send when the BLE BUCK asserts blebuck_comp1 for about 32.4 us (10 percent margin of error) or more"]
    SET6 = 6,
    #[doc = "5: Indicator send when the BLE BUCK asserts blebuck_comp1 for about 27.0 us (10 percent margin of error) or more"]
    SET5 = 5,
    #[doc = "4: Indicator send when the BLE BUCK asserts blebuck_comp1 for about 21.6 us (10 percent margin of error) or more"]
    SET4 = 4,
    #[doc = "3: Indicator send when the BLE BUCK asserts blebuck_comp1 for about 16.2 us (10 percent margin of error) or more"]
    SET3 = 3,
    #[doc = "2: Indicator send when the BLE BUCK asserts blebuck_comp1 for about 10.8 us (10 percent margin of error) or more"]
    SET2 = 2,
    #[doc = "1: Indicator send when the BLE BUCK asserts blebuck_comp1 for about 5.4 us (10 percent margin of error) or more"]
    SET1 = 1,
    #[doc = "0: Indicator send when the BLE BUCK asserts blebuck_comp1 for about 2.0 us (10 percent margin of error) or more"]
    SET0 = 0,
}
...
impl<'a> ZEROLENDETECTTRIM_W<'a> {
    ...
    #[doc = "Indicator send when the BLE BUCK asserts blebuck_comp1 for about 81 us (10 percent margin of error) or more"]
    #[inline(always)]
    pub fn set_f(self) -> &'a mut W {
        self.variant(ZEROLENDETECTTRIM_A::SETF)
    }
    #[doc = "Indicator send when the BLE BUCK asserts blebuck_comp1 for about 75.6 us (10 percent margin of error) or more"]
    #[inline(always)]
    pub fn set_e(self) -> &'a mut W {
        self.variant(ZEROLENDETECTTRIM_A::SETE)
    }
    #[doc = "Indicator send when the BLE BUCK asserts blebuck_comp1 for about 70.2 us (10 percent margin of error) or more"]
    #[inline(always)]
    pub fn set_d(self) -> &'a mut W {
        self.variant(ZEROLENDETECTTRIM_A::SETD)
    }
    #[doc = "Indicator send when the BLE BUCK asserts blebuck_comp1 for about 64.8 us (10 percent margin of error) or more"]
    #[inline(always)]
    pub fn set_c(self) -> &'a mut W {
        self.variant(ZEROLENDETECTTRIM_A::SETC)
    }
    #[doc = "Indicator send when the BLE BUCK asserts blebuck_comp1 for about 59.4 us (10 percent margin of error) or more"]
    #[inline(always)]
    pub fn set_b(self) -> &'a mut W {
        self.variant(ZEROLENDETECTTRIM_A::SETB)
    }
    #[doc = "Indicator send when the BLE BUCK asserts blebuck_comp1 for about 54.0 us (10 percent margin of error) or more"]
    #[inline(always)]
    pub fn set_a(self) -> &'a mut W {
        self.variant(ZEROLENDETECTTRIM_A::SETA)
    }
    #[doc = "Indicator send when the BLE BUCK asserts blebuck_comp1 for about 48.6 us (10 percent margin of error) or more"]
    #[inline(always)]
    pub fn set9(self) -> &'a mut W {
        self.variant(ZEROLENDETECTTRIM_A::SET9)
    }
    #[doc = "Indicator send when the BLE BUCK asserts blebuck_comp1 for about 43.2 us (10 percent margin of error) or more"]
    #[inline(always)]
    pub fn set8(self) -> &'a mut W {
        self.variant(ZEROLENDETECTTRIM_A::SET8)
    }
    #[doc = "Indicator send when the BLE BUCK asserts blebuck_comp1 for about 37.8 us (10 percent margin of error) or more"]
    #[inline(always)]
    pub fn set7(self) -> &'a mut W {
        self.variant(ZEROLENDETECTTRIM_A::SET7)
    }
    #[doc = "Indicator send when the BLE BUCK asserts blebuck_comp1 for about 32.4 us (10 percent margin of error) or more"]
    #[inline(always)]
    pub fn set6(self) -> &'a mut W {
        self.variant(ZEROLENDETECTTRIM_A::SET6)
    }
    #[doc = "Indicator send when the BLE BUCK asserts blebuck_comp1 for about 27.0 us (10 percent margin of error) or more"]
    #[inline(always)]
    pub fn set5(self) -> &'a mut W {
        self.variant(ZEROLENDETECTTRIM_A::SET5)
    }
    #[doc = "Indicator send when the BLE BUCK asserts blebuck_comp1 for about 21.6 us (10 percent margin of error) or more"]
    #[inline(always)]
    pub fn set4(self) -> &'a mut W {
        self.variant(ZEROLENDETECTTRIM_A::SET4)
    }
    #[doc = "Indicator send when the BLE BUCK asserts blebuck_comp1 for about 16.2 us (10 percent margin of error) or more"]
    #[inline(always)]
    pub fn set3(self) -> &'a mut W {
        self.variant(ZEROLENDETECTTRIM_A::SET3)
    }
    #[doc = "Indicator send when the BLE BUCK asserts blebuck_comp1 for about 10.8 us (10 percent margin of error) or more"]
    #[inline(always)]
    pub fn set2(self) -> &'a mut W {
        self.variant(ZEROLENDETECTTRIM_A::SET2)
    }
    #[doc = "Indicator send when the BLE BUCK asserts blebuck_comp1 for about 5.4 us (10 percent margin of error) or more"]
    #[inline(always)]
    pub fn set1(self) -> &'a mut W {
        self.variant(ZEROLENDETECTTRIM_A::SET1)
    }
    #[doc = "Indicator send when the BLE BUCK asserts blebuck_comp1 for about 2.0 us (10 percent margin of error) or more"]
    #[inline(always)]
