...
pub enum BURSTEVEN_A {
    #[doc = "1: Enable BURST status event"]
    EN = 1,
    #[doc = "0: Disable BURST status event"]
    DIS = 0,
}
...
impl<'a> BURSTEVEN_W<'a> {
    ...
    #[doc = "Enable BURST status event"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(BURSTEVEN_A::EN)
    }
    #[doc = "Disable BURST status event"]
    #[inline(always)]
...
pub enum BURSTFEATUREEVEN_A {
    #[doc = "1: Enable BURSTFEATURE status event"]
    EN = 1,
    #[doc = "0: Disable BURSTFEATURE status event"]
    DIS = 0,
}
...
impl<'a> BURSTFEATUREEVEN_W<'a> {
    ...
    #[doc = "Enable BURSTFEATURE status event"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(BURSTFEATUREEVEN_A::EN)
    }
    #[doc = "Disable BURSTFEATURE status event"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
...
pub enum BLEFEATUREEVEN_A {
    #[doc = "1: Enable BLEFEATURE status event"]
    EN = 1,
    #[doc = "0: Disable BLEFEATURE status event"]
    DIS = 0,
}
...
impl<'a> BLEFEATUREEVEN_W<'a> {
    ...
    #[doc = "Enable BLEFEATURE status event"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(BLEFEATUREEVEN_A::EN)
    }
    #[doc = "Disable BLEFEATURE status event"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BLELEVEN_A {
    #[doc = "1: Enable BLE power-on status event"]
    EN = 1,
    #[doc = "0: Disable BLE power-on status event"]
    DIS = 0,
}
...
impl<'a> BLELEVEN_W<'a> {
    ...
    #[doc = "Enable BLE power-on status event"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(BLELEVEN_A::EN)
    }
    #[doc = "Disable BLE power-on status event"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PDMEVEN_A {
    #[doc = "1: Enable PDM power-on status event"]
    EN = 1,
    #[doc = "0: Disable PDM power-on status event"]
    DIS = 0,
}
...
impl<'a> PDMEVEN_W<'a> {
    ...
    #[doc = "Enable PDM power-on status event"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(PDMEVEN_A::EN)
    }
    #[doc = "Disable PDM power-on status event"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
