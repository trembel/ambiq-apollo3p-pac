...
impl From<PWRMSPI2_A> for bool {
    #[inline(always)]
    fn from(variant: PWRMSPI2_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Reader of field `PWRMSPI2`"]
pub type PWRMSPI2_R = crate::R<bool, PWRMSPI2_A>;
impl PWRMSPI2_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `PWRMSPI2`"]
pub struct PWRMSPI2_W<'a> {
    w: &'a mut W,
}
impl<'a> PWRMSPI2_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: PWRMSPI2_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
    ...
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(PWRMSPI2_A::EN)
    }
    #[doc = "Power down MSPI2"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(PWRMSPI2_A::DIS)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl From<PWRMSPI1_A> for bool {
    #[inline(always)]
    fn from(variant: PWRMSPI1_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Reader of field `PWRMSPI1`"]
pub type PWRMSPI1_R = crate::R<bool, PWRMSPI1_A>;
impl PWRMSPI1_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `PWRMSPI1`"]
pub struct PWRMSPI1_W<'a> {
    w: &'a mut W,
}
impl<'a> PWRMSPI1_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: PWRMSPI1_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
    ...
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(PWRMSPI1_A::EN)
    }
    #[doc = "Power down MSPI1"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(PWRMSPI1_A::DIS)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl From<PWRMSPI0_A> for bool {
    #[inline(always)]
    fn from(variant: PWRMSPI0_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Reader of field `PWRMSPI0`"]
pub type PWRMSPI0_R = crate::R<bool, PWRMSPI0_A>;
impl PWRMSPI0_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `PWRMSPI0`"]
pub struct PWRMSPI0_W<'a> {
    w: &'a mut W,
}
impl<'a> PWRMSPI0_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: PWRMSPI0_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
    ...
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(PWRMSPI0_A::EN)
    }
    #[doc = "Power down MSPI0"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(PWRMSPI0_A::DIS)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    #[doc = "Bit 15 - Power up BLE controller"]
    #[inline(always)]
    pub fn pwrblel(&self) -> PWRBLEL_R {
        PWRBLEL_R::new(((self.bits >> 15) & 0x01) != 0)
    }
    #[doc = "Bit 14 - Power up PDM block"]
    #[inline(always)]
    pub fn pwrpdm(&self) -> PWRPDM_R {
        PWRPDM_R::new(((self.bits >> 14) & 0x01) != 0)
    }
    #[doc = "Bit 13 - Power up MSPI2 Controller"]
    #[inline(always)]
    pub fn pwrmspi2(&self) -> PWRMSPI2_R {
        PWRMSPI2_R::new(((self.bits >> 13) & 0x01) != 0)
    }
    #[doc = "Bit 12 - Power up MSPI1 Controller"]
    #[inline(always)]
    pub fn pwrmspi1(&self) -> PWRMSPI1_R {
        PWRMSPI1_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    #[doc = "Bit 11 - Power up MSPI0 Controller"]
    #[inline(always)]
    pub fn pwrmspi0(&self) -> PWRMSPI0_R {
        PWRMSPI0_R::new(((self.bits >> 11) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 13 - Power up MSPI2 Controller"]
    #[inline(always)]
    pub fn pwrmspi2(&mut self) -> PWRMSPI2_W {
        PWRMSPI2_W { w: self }
    }
    #[doc = "Bit 12 - Power up MSPI1 Controller"]
    #[inline(always)]
    pub fn pwrmspi1(&mut self) -> PWRMSPI1_W {
        PWRMSPI1_W { w: self }
    }
    #[doc = "Bit 11 - Power up MSPI0 Controller"]
    #[inline(always)]
    pub fn pwrmspi0(&mut self) -> PWRMSPI0_W {
        PWRMSPI0_W { w: self }
    }
    #[doc = "Bit 10 - Power up SCARD Controller"]
    #[inline(always)]
