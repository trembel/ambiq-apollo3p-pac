...
#[doc = "Power-down FLASH1 in deep sleep\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum FLASH1PWDSLP_A {
    #[doc = "1: FLASH1 is powered down during deep sleep"]
    EN = 1,
    #[doc = "0: FLASH1 is kept powered on during deep sleep"]
    DIS = 0,
}
...
impl<'a> FLASH1PWDSLP_W<'a> {
    ...
    #[doc = "FLASH1 is powered down during deep sleep"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(FLASH1PWDSLP_A::EN)
    }
    #[doc = "FLASH1 is kept powered on during deep sleep"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
...
#[doc = "Power-down FLASH0 in deep sleep\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum FLASH0PWDSLP_A {
    #[doc = "1: FLASH0 is powered down during deep sleep"]
    EN = 1,
    #[doc = "0: FLASH0 is kept powered on during deep sleep"]
    DIS = 0,
}
...
impl<'a> FLASH0PWDSLP_W<'a> {
    ...
    #[doc = "FLASH0 is powered down during deep sleep"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(FLASH0PWDSLP_A::EN)
    }
    #[doc = "FLASH0 is kept powered on during deep sleep"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
...
pub enum SRAMPWDSLP_A {
    ...
    NONE = 0,
    #[doc = "1: SRAM GROUP0 powered down (64KB-128KB)"]
    GROUP0 = 1,
    #[doc = "2: SRAM GROUP1 powered down (128KB-192KB)"]
    GROUP1 = 2,
    #[doc = "4: SRAM GROUP2 powered down (192KB-256KB)"]
    GROUP2 = 4,
    #[doc = "8: SRAM GROUP3 powered down (256KB-320KB)"]
    GROUP3 = 8,
    #[doc = "16: SRAM GROUP4 powered down (320KB-384KB)"]
    GROUP4 = 16,
    #[doc = "32: SRAM GROUP5 powered down (384KB-448KB)"]
    GROUP5 = 32,
    #[doc = "64: SRAM GROUP6 powered down (448KB-512KB)"]
    GROUP6 = 64,
    #[doc = "128: SRAM GROUP7 powered down (512KB-576KB)"]
    GROUP7 = 128,
    #[doc = "256: SRAM GROUP8 powered down (576KB-672KB)"]
    GROUP8 = 256,
    #[doc = "512: SRAM GROUP9 powered down (672KB-768KB)"]
    GROUP9 = 512,
    #[doc = "3: Power-down lower 128k SRAM (64KB-192KB)"]
    SRAM128K = 3,
    #[doc = "15: Power-down lower 256k SRAM (64KB-320KB)"]
    SRAM256K = 15,
    #[doc = "1022: All SRAM banks but lower 64k powered down."]
    ALLBUTLOWER64K = 1022,
    #[doc = "1020: All banks but lower 128k powered down."]
    ALLBUTLOWER128K = 1020,
    #[doc = "1008: All banks but lower 256k powered down."]
    ALLBUTLOWER256K = 1008,
...
impl SRAMPWDSLP_R {
    ...
    pub fn variant(&self) -> crate::Variant<u16, SRAMPWDSLP_A> {
        ...
        match self.bits {
            ...
            3 => Val(SRAMPWDSLP_A::SRAM128K),
            15 => Val(SRAMPWDSLP_A::SRAM256K),
            1022 => Val(SRAMPWDSLP_A::ALLBUTLOWER64K),
            1020 => Val(SRAMPWDSLP_A::ALLBUTLOWER128K),
            1008 => Val(SRAMPWDSLP_A::ALLBUTLOWER256K),
    ...
    #[doc = "Checks if the value of the field is `ALLBUTLOWER256K`"]
    #[inline(always)]
    pub fn is_allbutlower256k(&self) -> bool {
        *self == SRAMPWDSLP_A::ALLBUTLOWER256K
    }
...
impl<'a> SRAMPWDSLP_W<'a> {
    ...
    #[doc = "All banks but lower 256k powered down."]
    #[inline(always)]
    pub fn allbutlower256k(self) -> &'a mut W {
        self.variant(SRAMPWDSLP_A::ALLBUTLOWER256K)
    }
...
impl R {
    ...
    #[doc = "Bit 14 - Power-down FLASH1 in deep sleep"]
    #[inline(always)]
    pub fn flash1pwdslp(&self) -> FLASH1PWDSLP_R {
        FLASH1PWDSLP_R::new(((self.bits >> 14) & 0x01) != 0)
    }
    #[doc = "Bit 13 - Power-down FLASH0 in deep sleep"]
    #[inline(always)]
