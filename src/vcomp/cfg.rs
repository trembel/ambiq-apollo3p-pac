...
#[doc = "When the reference input NSEL is set to NSEL_DAC, this bit field selects the voltage level for the negative input to the comparator.\n\nValue on reset: 0"]
...
#[doc = "This bit field selects the negative input to the comparator.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum NSEL_A {
...
#[doc = "This bit field selects the positive input to the comparator.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum PSEL_A {
    #[doc = "0: Use VDDADJ for the positive input."]
    VDDADJ = 0,
    #[doc = "1: Use the temperature sensor output for the positive input. Note: If this channel is selected for PSEL, the bandgap circuit required for temperature comparisons will automatically turn on. The bandgap circuit requires 11 us to stabilize."]
    VTEMP = 1,
...
impl<'a> PSEL_W<'a> {
    ...
    #[doc = "Use the temperature sensor output for the positive input. Note: If this channel is selected for PSEL, the bandgap circuit required for temperature comparisons will automatically turn on. The bandgap circuit requires 11 us to stabilize."]
    #[inline(always)]
...
impl R {
    #[doc = "Bits 16:19 - When the reference input NSEL is set to NSEL_DAC, this bit field selects the voltage level for the negative input to the comparator."]
    #[inline(always)]
    pub fn lvlsel(&self) -> LVLSEL_R {
        LVLSEL_R::new(((self.bits >> 16) & 0x0f) as u8)
    }
    #[doc = "Bits 8:9 - This bit field selects the negative input to the comparator."]
    #[inline(always)]
    pub fn nsel(&self) -> NSEL_R {
        NSEL_R::new(((self.bits >> 8) & 0x03) as u8)
    }
    #[doc = "Bits 0:1 - This bit field selects the positive input to the comparator."]
    #[inline(always)]
