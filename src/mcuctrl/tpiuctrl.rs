...
pub enum CLKSEL_A {
    ...
    LOWPWR = 0,
    #[doc = "1: Selects HFRC divided by 2 as the source TPIU clock"]
    HFRCDIV2 = 1,
    #[doc = "2: Selects HFRC divided by 8 as the source TPIU clock"]
    HFRCDIV8 = 2,
    #[doc = "3: Selects HFRC divided by 16 as the source TPIU clock"]
    HFRCDIV16 = 3,
    #[doc = "4: Selects HFRC divided by 32 as the source TPIU clock"]
    HFRCDIV32 = 4,
}
...
impl<'a> CLKSEL_W<'a> {
    ...
    #[doc = "Selects HFRC divided by 2 as the source TPIU clock"]
    #[inline(always)]
    pub fn hfrcdiv2(self) -> &'a mut W {
        self.variant(CLKSEL_A::HFRCDIV2)
    }
    #[doc = "Selects HFRC divided by 8 as the source TPIU clock"]
    #[inline(always)]
    pub fn hfrcdiv8(self) -> &'a mut W {
        self.variant(CLKSEL_A::HFRCDIV8)
    }
    #[doc = "Selects HFRC divided by 16 as the source TPIU clock"]
    #[inline(always)]
    pub fn hfrcdiv16(self) -> &'a mut W {
        self.variant(CLKSEL_A::HFRCDIV16)
    }
    #[doc = "Selects HFRC divided by 32 as the source TPIU clock"]
    #[inline(always)]
