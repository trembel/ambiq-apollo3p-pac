...
pub enum BURSTAVAIL_A {
    #[doc = "1: Burst functionality available"]
    AVAIL = 1,
    #[doc = "0: Burst functionality not available"]
    NOTAVAIL = 0,
}
...
impl<'a> BURSTAVAIL_W<'a> {
    ...
    #[doc = "Burst functionality available"]
    #[inline(always)]
    pub fn avail(self) -> &'a mut W {
        self.variant(BURSTAVAIL_A::AVAIL)
    }
    #[doc = "Burst functionality not available"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BURSTREQ_A {
    #[doc = "1: Enable the Burst functionality"]
    EN = 1,
    #[doc = "0: Disable the Burst functionality"]
    DIS = 0,
}
...
impl<'a> BURSTREQ_W<'a> {
    ...
    #[doc = "Enable the Burst functionality"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(BURSTREQ_A::EN)
    }
    #[doc = "Disable the Burst functionality"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BLEAVAIL_A {
    #[doc = "1: BLE functionality available"]
    AVAIL = 1,
    #[doc = "0: BLE functionality not available"]
    NOTAVAIL = 0,
}
...
impl<'a> BLEAVAIL_W<'a> {
    ...
    #[doc = "BLE functionality available"]
    #[inline(always)]
    pub fn avail(self) -> &'a mut W {
        self.variant(BLEAVAIL_A::AVAIL)
    }
    #[doc = "BLE functionality not available"]
    #[inline(always)]
    pub fn notavail(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BLEREQ_A {
    #[doc = "1: Enable the BLE functionality"]
    EN = 1,
    #[doc = "0: Disable the BLE functionality"]
    DIS = 0,
}
...
impl<'a> BLEREQ_W<'a> {
    ...
    #[doc = "Enable the BLE functionality"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(BLEREQ_A::EN)
    }
    #[doc = "Disable the BLE functionality"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
