...
pub struct RegisterBlock {
    ...
    pub clkout: CLKOUT,
    #[doc = "0x14 - Key for Clock Control Register"]
    pub clkkey: CLKKEY,
    ...
    #[doc = "0x100 - CLKGEN Interrupt: Enable"]
    pub intrpten: INTRPTEN,
    #[doc = "0x104 - CLKGEN Interrupt: Status"]
    pub intrptstat: INTRPTSTAT,
    #[doc = "0x108 - CLKGEN Interrupt: Clear"]
    pub intrptclr: INTRPTCLR,
    #[doc = "0x10c - CLKGEN Interrupt: Set"]
