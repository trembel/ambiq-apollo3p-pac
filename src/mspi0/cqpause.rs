...
impl CQMASK_R {
    ...
    pub fn variant(&self) -> crate::Variant<u16, CQMASK_A> {
        ...
        match self.bits {
            ...
            8192 => Val(CQMASK_A::BUF1XOREN),
            4096 => Val(CQMASK_A::BUF0XOREN),
...
impl<'a> CQMASK_W<'a> {
    ...
    pub fn buf1xoren(self) -> &'a mut W {
        self.variant(CQMASK_A::BUF1XOREN)
    }
    ...
    pub fn buf0xoren(self) -> &'a mut W {
        self.variant(CQMASK_A::BUF0XOREN)
    }
