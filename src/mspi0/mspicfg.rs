...
impl IOMSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, IOMSEL_A> {
        ...
        match self.bits {
            ...
            4 => Val(IOMSEL_A::IOM4),
            5 => Val(IOMSEL_A::IOM5),
            8 => Val(IOMSEL_A::MSPI0),
            9 => Val(IOMSEL_A::MSPI1),
            10 => Val(IOMSEL_A::MSPI2),
...
impl<'a> IOMSEL_W<'a> {
    ...
    pub fn mspi0(self) -> &'a mut W {
        self.variant(IOMSEL_A::MSPI0)
    }
    #[doc = "MSPI1"]
    #[inline(always)]
    pub fn mspi1(self) -> &'a mut W {
        self.variant(IOMSEL_A::MSPI1)
    }
    #[doc = "MSPI2"]
    #[inline(always)]
    pub fn mspi2(self) -> &'a mut W {
        self.variant(IOMSEL_A::MSPI2)
    }
...
impl R {
    ...
    pub fn iomsel(&self) -> IOMSEL_R {
        IOMSEL_R::new(((self.bits >> 4) & 0x0f) as u8)
    }
