...
#[doc = "Reader of field `ENDCX`"]
pub type ENDCX_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `ENDCX`"]
pub struct ENDCX_W<'a> {
    w: &'a mut W,
}
impl<'a> ENDCX_W<'a> {
...
#[doc = "Reader of field `ENWLAT`"]
pub type ENWLAT_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `ENWLAT`"]
pub struct ENWLAT_W<'a> {
    w: &'a mut W,
}
impl<'a> ENWLAT_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    pub fn endcx(&self) -> ENDCX_R {
        ENDCX_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    ...
    #[doc = "Bit 4 - Enable Write Latency Counter (time between address and first data byte). Counter value is WRITELATENCY."]
    #[inline(always)]
    pub fn enwlat(&self) -> ENWLAT_R {
        ENWLAT_R::new(((self.bits >> 4) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 4 - Enable Write Latency Counter (time between address and first data byte). Counter value is WRITELATENCY."]
    #[inline(always)]
    pub fn enwlat(&mut self) -> ENWLAT_W {
        ENWLAT_W { w: self }
    }
    #[doc = "Bit 3 - Flag indicating that the operation is a command that should be replicated to both devices in paired QUAD mode. This is typically only used when reading/writing configuration registers in paired flash devices (do not set for memory transfers)."]
    #[inline(always)]
