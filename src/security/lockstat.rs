...
#[doc = "LOCK Status register. This register is a bit mask for which resources are currently unlocked. These bits are one-hot per resource.\n\nValue on reset: 0"]
...
impl R {
    #[doc = "Bits 0:31 - LOCK Status register. This register is a bit mask for which resources are currently unlocked. These bits are one-hot per resource."]
    #[inline(always)]
