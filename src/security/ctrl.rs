...
impl FUNCTION_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCTION_A> {
        ...
        match self.bits {
            ...
            1 => Val(FUNCTION_A::RAND),
            2 => Val(FUNCTION_A::GENADDR),
            i => Res(i),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `RAND`"]
    #[inline(always)]
    pub fn is_rand(&self) -> bool {
        *self == FUNCTION_A::RAND
    }
    #[doc = "Checks if the value of the field is `GENADDR`"]
    #[inline(always)]
    pub fn is_genaddr(&self) -> bool {
        *self == FUNCTION_A::GENADDR
    }
}
...
impl<'a> FUNCTION_W<'a> {
    ...
    #[inline(always)]
    pub fn rand(self) -> &'a mut W {
        self.variant(FUNCTION_A::RAND)
    }
    #[doc = "Generate DMA stream based on address"]
    #[inline(always)]
    pub fn genaddr(self) -> &'a mut W {
        self.variant(FUNCTION_A::GENADDR)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
